...
$pyjs['loaded_modules']['Schedule'] = function (__mod_name__) {
	...
	try {
		...
		$m['Schedule'] = (function(){
			...
			$cls_definition['__md5__'] = '457e02fe26d04982e8d77506cf7603fb';
			$method = $pyjs__bind_method2('__init__', function(timeSlots) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '457e02fe26d04982e8d77506cf7603fb') {
				...
				var $bool1;
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timeSlots', $p['list']([])) : $p['setattr'](self, 'timeSlots', $p['list']([])); 
				if ((($bool1=!$p['op_is'](timeSlots, null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
							(typeof $bool1['__nonzero__']=='function'?
								...
								(typeof $bool1['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timeSlots', timeSlots) : $p['setattr'](self, 'timeSlots', timeSlots); 
				}
				return null;
			}
	...
	, 1, [null,null,['self'],['timeSlot']]);
			...
			$method = $pyjs__bind_method2('getDescription', function(daysFilter) {
							...
							(typeof $bool2=='object'?
								(typeof $bool2['__nonzero__']=='function'?
									...
									(typeof $bool2['__len__']=='function'?
										...
										true ) ) :
								 true ) )) {
						if ((($bool3=$p['op_is'](s, null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
								false :
								(typeof $bool3=='object'?
				...
				if ((($bool4=$p['op_is'](s, null)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
