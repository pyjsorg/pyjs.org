...
$pyjs['loaded_modules']['Text'] = function (__mod_name__) {
	...
	try {
		...
		$m['Text'] = (function(){
			...
			$cls_definition['__md5__'] = 'a6e38aa14da39aed76d216f9c9ade4c6';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'a6e38aa14da39aed76d216f9c9ade4c6') {
	...
	, 1, [null,null,['self'],['text'],['echo']]);
		...
		$m['TextBoxListener'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'Text';
			$cls_definition['__md5__'] = 'eef2403cd42d497b6c3f4ceae91bedac';
			$method = $pyjs__bind_method2('__init__', function(parent, textBox, echo, select_all) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'eef2403cd42d497b6c3f4ceae91bedac') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
