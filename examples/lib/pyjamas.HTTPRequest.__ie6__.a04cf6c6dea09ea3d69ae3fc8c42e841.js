...
$pyjs['loaded_modules']['pyjamas.HTTPRequest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$m['HTTPRequest'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.HTTPRequest';
			$cls_definition['__md5__'] = '8c3d1541b635be3b042baf31559676fb';
			$method = $pyjs__bind_method2('asyncGet', function(url, handler, returnxml, content_type, headers, user, pwd) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '8c3d1541b635be3b042baf31559676fb') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['url']]);
			...
			$method = $pyjs__bind_method2('asyncImpl', function(method, user, pwd, url, postData, handler, returnxml, content_type, headers) {
				...
				onreadystatechange = function(evnt) {
					...
					var status,$or5,localHandler,$bool33,$bool36,$bool34,$bool35,response,$or6;
					if ((($bool33=$p['op_eq']($p['getattr'](xmlHttp, 'readyState'), $constant_int_4)) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
							false :
...
delete xmlHttp['onreadystatechange'];
						...
						handler = null;
						xmlHttp = null;
						if ((($bool36=((($bool35=$or5=$p['op_eq'](status, $constant_int_200)) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
							false :
								...
								(typeof $bool35['__nonzero__']=='function'?
									...
									(typeof $bool35['__len__']=='function'?
										($bool35['__len__']()>0 ?
											...
											false) :
										true ) ) :
								 true ) )?$or5:$p['op_eq'](status, $constant_int_0))) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
								false :
				...
				if ((($bool37=$p['hasattr'](handler, 'onProgress')) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
						false :
	...
	return $collcomp1;}());
					...
					if ((($bool39=$p['op_is'](postData, null)) === null || $bool39 === false || $bool39 === 0 || $bool39 === '' ?
							false :
