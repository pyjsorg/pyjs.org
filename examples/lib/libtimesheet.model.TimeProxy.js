/* start module: libtimesheet.model.TimeProxy */
$pyjs['loaded_modules']['libtimesheet.model.TimeProxy'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.model.TimeProxy']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.model.TimeProxy'];
	if(typeof $pyjs['loaded_modules']['libtimesheet.model'] == 'undefined' || !$pyjs['loaded_modules']['libtimesheet.model']['__was_initialized__']) $p['___import___']('libtimesheet.model', null);
	var $m = $pyjs['loaded_modules']['libtimesheet.model.TimeProxy'];
	$m['__repr__'] = function() { return '<module: libtimesheet.model.TimeProxy>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.model.TimeProxy';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.model']['TimeProxy'] = $pyjs['loaded_modules']['libtimesheet.model.TimeProxy'];
	try {
		...
		$m['TimeVO'] = $p['___import___']('vo.TimeVO.TimeVO', 'libtimesheet.model', null, false);
		$m['time'] = $p['___import___']('time', 'libtimesheet.model');
		$m['TimeProxy'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.model.TimeProxy';
			$cls_definition['__md5__'] = '21f4582b5b1c3bfc2857f1da87fc65d1';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '21f4582b5b1c3bfc2857f1da87fc65d1') {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('importData', function(data, onError) {
				...
				var $iter5_nextval,$bool10,$bool11,$bool12,$bool5,$bool14,cols,$iter5_iter,$iter4_type,$iter5_type,$10,$iter4_iter,$bool8,$iter4_idx,$iter5_idx,$iter3_idx,$iter3_array,$iter3_iter,$iter5_array,today,lineno,$or5,$or4,$bool13,$or1,$or3,$or2,dates,timeVO,$9,$bool6,$bool7,$8,$iter3_type,date,$7,line,$bool9,dateEntries,$14,$15,$16,$17,$cmp1,$11,$12,$cmp2,thisDate,$iter4_nextval,$18,$13,lines,$add2,s,$add1,$len2,$len3,$len1,$iter4_array,$iter3_nextval;
				today = $m['time']['strftime']('%Y%m%d', $m['time']['localtime']());
				dateEntries = $p['dict']([]);
				lines = data['$$split']('\n');
				if ((($bool5=$p['op_eq']((($len1=lines) === null?$constant_int_0:
					(typeof $len1['__array'] != 'undefined' ? new $p['int']($len1['__array']['length']):
						(typeof $len1['__len__'] == 'function'?$len1['__len__']():
							(typeof $len1['length'] != 'undefined'? new $p['int']($len1['length']):
								$p['len']($len1))))), $constant_int_1)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
				...
				while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
					...
					lineno = (typeof ($add1=lineno)==typeof ($add2=$constant_int_1) && (typeof $add1=='number'||typeof $add1=='string')?
						...
						$p['op_add']($add1,$add2));
					line = line['strip']();
					if ((($bool7=((($bool6=$or1=$p['op_eq'](line, '')) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
						false :
						(typeof $bool6=='object'?
							(typeof $bool6['__nonzero__']=='function'?
								...
								(typeof $bool6['__len__']=='function'?
									($bool6['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$or1:$p['op_eq']((typeof ($7=line)['__array'] != 'undefined'?
						((typeof $7['__array'][$8=$constant_int_0]) != 'undefined'?$7['__array'][$8]:
							$7['__getitem__']($8)):
							$7['__getitem__']($constant_int_0)), '#'))) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
							false :
							(typeof $bool7=='object'?
					...
					if ((($bool10=((($bool8=$or3=((($cmp1=(($len2=line) === null?$constant_int_0:
						(typeof $len2['__array'] != 'undefined' ? new $p['int']($len2['__array']['length']):
							(typeof $len2['__len__'] == 'function'?$len2['__len__']():
								(typeof $len2['length'] != 'undefined'? new $p['int']($len2['length']):
									$p['len']($len2))))))===($cmp2=$constant_int_3)?0:
							...
							(typeof $bool8['__nonzero__']=='function'?
								...
								(typeof $bool8['__len__']=='function'?
									($bool8['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$or3:((($bool9=$or4=!$p['op_eq']((typeof ($9=line)['__array'] != 'undefined'?
						((typeof $9['__array'][$10=$constant_int_0]) != 'undefined'?$9['__array'][$10]:
							$9['__getitem__']($10)):
							$9['__getitem__']($constant_int_0)), '"')) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
						false :
						(typeof $bool9=='object'?
							(typeof $bool9['__nonzero__']=='function'?
								...
								(typeof $bool9['__len__']=='function'?
									($bool9['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$or4:!$p['op_eq']((typeof ($11=line)['__array'] != 'undefined'?
						((typeof $11['__array'][$12=(typeof ($usub1=$constant_int_1)=='number'?
						-$usub1:
						$p['op_usub']($usub1))]) != 'undefined'?$11['__array'][$12]:
							$11['__getitem__']($12)):
							$11['__getitem__']((typeof ($usub1=$constant_int_1)=='number'?
						-$usub1:
						$p['op_usub']($usub1)))), '"')))) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
							false :
					...
					s = $p['__getslice'](line, $constant_int_1, (typeof ($usub2=$constant_int_1)=='number'?
						-$usub2:
						$p['op_usub']($usub2)));
					cols = s['$$split']('","');
					if ((($bool11=!$p['op_eq']((($len3=cols) === null?$constant_int_0:
						(typeof $len3['__array'] != 'undefined' ? new $p['int']($len3['__array']['length']):
							(typeof $len3['__len__'] == 'function'?$len3['__len__']():
								(typeof $len3['length'] != 'undefined'? new $p['int']($len3['length']):
									$p['len']($len3))))), $constant_int_5)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
							false :
					...
					if ((($bool12=$p['op_eq'](date, 'TODAY')) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
							false :
					...
					(typeof ($15=dateEntries)['__array'] != 'undefined'?
						((typeof $15['__array'][$16=date]) != 'undefined'?$15['__array'][$16]:
							$15['__getitem__']($16)):
							$15['__getitem__'](date))['append']($p['__getslice'](cols, $constant_int_1, null));
				}
				self['clear']();
	...
	return this;
}; /* end libtimesheet.model.TimeProxy */


/* end module: libtimesheet.model.TimeProxy */
