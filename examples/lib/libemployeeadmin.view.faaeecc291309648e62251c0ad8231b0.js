/* start module: libemployeeadmin.view */
$pyjs['loaded_modules']['libemployeeadmin.view'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libemployeeadmin.view']['__was_initialized__']) return $pyjs['loaded_modules']['libemployeeadmin.view'];
	...
	var $m = $pyjs['loaded_modules']['libemployeeadmin.view'];
	$m['__repr__'] = function() { return '<module: libemployeeadmin.view>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libemployeeadmin.view';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libemployeeadmin']['view'] = $pyjs['loaded_modules']['libemployeeadmin.view'];
	try {

		var $constant_int_0 = new $p['int'](0);
		$m['Mediator'] = $p['___import___']('puremvc.patterns.mediator.Mediator', 'libemployeeadmin', null, false);
		...
		$m['alert'] = $p['___import___']('pyjamas.Window.alert', 'libemployeeadmin', null, false);
		$m['DialogMediator'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.view';
			$cls_definition['__md5__'] = 'a6e504a5bb12c88b0bb961ecf922c7bc';
			...
			$method = $pyjs__bind_method2('__init__', function(viewComponent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'a6e504a5bb12c88b0bb961ecf922c7bc') {
	...
	, 1, [null,null,['self'],['note']]);
		...
		$m['UserFormMediator'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.view';
			$cls_definition['__md5__'] = '5c5e5372bb8239399d8736faa809a8cc';
			...
			$method = $pyjs__bind_method2('__init__', function(viewComponent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '5c5e5372bb8239399d8736faa809a8cc') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['evnt']]);
		...
		$m['UserListMediator'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.view';
			$cls_definition['__md5__'] = 'fae78ef55384246a4b1813315a69bb36';
			...
			$method = $pyjs__bind_method2('__init__', function(viewComponent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'fae78ef55384246a4b1813315a69bb36') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['evnt']]);
		...
		$m['RolePanelMediator'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.view';
			$cls_definition['__md5__'] = '2a0367ddf06400e8bfcbe2828c110f9a';
			...
			$method = $pyjs__bind_method2('__init__', function(viewComponent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '2a0367ddf06400e8bfcbe2828c110f9a') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	return this;
}; /* end libemployeeadmin.view */


/* end module: libemployeeadmin.view */
