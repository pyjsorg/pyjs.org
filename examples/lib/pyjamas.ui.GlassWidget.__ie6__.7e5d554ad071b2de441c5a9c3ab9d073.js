				...
				kwargs = $p['__empty_dict']();
{
	...
	, 1, [null,null,['self'],['event']]);
			...
			$method = $pyjs__bind_method2('onEventPreview', function(event) {
				...
				var $or5,$or4,$or6,$or1,$bool18,$or3,$or2,$bool11,$bool13,$bool14,$bool15,$bool16,$bool17,$bool12,etype;
				etype = $m['DOM']['eventGetType'](event);
				if ((($bool12=((($bool11=$or1=$p['op_eq'](etype, 'mousedown')) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
					false :
						...
						(typeof $bool11['__nonzero__']=='function'?
							...
							(typeof $bool11['__len__']=='function'?
								($bool11['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or1:$p['op_eq'](etype, 'blur'))) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
						false :
						(typeof $bool12=='object'?
							(typeof $bool12['__nonzero__']=='function'?
								...
								(typeof $bool12['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool13=!$p['op_is']($m['DOM']['getCaptureElement'](), null)) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
							false :
				...
				else if ((($bool17=((($bool14=$or3=$p['op_eq'](etype, 'mouseup')) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
					false :
						...
						(typeof $bool14['__nonzero__']=='function'?
							...
							(typeof $bool14['__len__']=='function'?
								($bool14['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or3:((($bool15=$or4=$p['op_eq'](etype, 'click')) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
					false :
						...
						(typeof $bool15['__nonzero__']=='function'?
							...
							(typeof $bool15['__len__']=='function'?
								($bool15['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or4:((($bool16=$or5=$p['op_eq'](etype, 'mousemove')) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
					false :
						...
						(typeof $bool16['__nonzero__']=='function'?
							...
							(typeof $bool16['__len__']=='function'?
								($bool16['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or5:$p['op_eq'](etype, 'dblclick'))))) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
						false :
						(typeof $bool17=='object'?
							(typeof $bool17['__nonzero__']=='function'?
								...
								(typeof $bool17['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool18=!$p['op_is']($m['DOM']['getCaptureElement'](), null)) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
							false :
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('setGlassPosition', function() {
				...
				var el,$bool19,$add3,height,$add2,width,$add1,$bool21,$bool20,$add4,top,left;
				...
				$m['DOM']['setStyleAttribute'](el, 'left', ((($bool19=$p['op_eq'](left, $constant_int_0)) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					false :
				...
				$m['DOM']['setStyleAttribute'](el, 'top', ((($bool20=$p['op_eq'](top, $constant_int_0)) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
					false :
