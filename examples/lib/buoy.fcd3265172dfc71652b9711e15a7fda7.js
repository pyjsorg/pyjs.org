...
$pyjs['loaded_modules']['buoy'] = function (__mod_name__) {
	...
	try {
		...
		var $constant_int_0 = new $p['int'](0);
		var $constant_int_251 = new $p['int'](251);
		...
		$m['Flare'] = (function(){
			...
			$cls_definition['__md5__'] = '1aebd0741ea1f07d14abe084150cf24c';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '1aebd0741ea1f07d14abe084150cf24c') {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('params', $p['dict']([])) : $p['setattr'](self, 'params', $p['dict']([])); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('flare', null) : $p['setattr'](self, 'flare', null); 
				return null;
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['params']]);
		...
		$m['Buoy'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'buoy';
			$cls_definition['__md5__'] = 'fc538f3130474402fedcb476d0d7a458';
			$method = $pyjs__bind_method2('__init__', function(parent, title) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'fc538f3130474402fedcb476d0d7a458') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('crumb', ((($bool2=crumb) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
						(typeof $bool2['__nonzero__']=='function'?
							...
							(typeof $bool2['__len__']=='function'?
								($bool2['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )? (crumb) : (title))) : $p['setattr'](self, 'crumb', ((($bool2=crumb) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
						(typeof $bool2['__nonzero__']=='function'?
							$bool2['__nonzero__']() :
						...
						(typeof $bool7=='object'?
							(typeof $bool7['__nonzero__']=='function'?
								...
								(typeof $bool7['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('flare', $p['getattr']($p['getattr']($p['getattr'](self, 'parent'), 'flare'), 'flare')) : $p['setattr'](self, 'flare', $p['getattr']($p['getattr']($p['getattr'](self, 'parent'), 'flare'), 'flare')); 
				}
				else {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('flare', $p['getattr']($p['getattr'](self, 'parent'), 'flare')) : $p['setattr'](self, 'flare', $p['getattr']($p['getattr'](self, 'parent'), 'flare')); 
				}
				$p['getattr'](self, 'parent')['__is_instance__'] && typeof $p['getattr'](self, 'parent')['__setattr__'] == 'function' ? $p['getattr'](self, 'parent')['__setattr__']('flare', null) : $p['setattr']($p['getattr'](self, 'parent'), 'flare', null); 
						...
						(typeof $bool14=='object'?
							(typeof $bool14['__nonzero__']=='function'?
								...
								(typeof $bool14['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					titles['insert']($constant_int_0, $p['getattr'](obj, 'title'));
							...
							(typeof $bool16['__nonzero__']=='function'?
								...
								(typeof $bool16['__len__']=='function'?
									($bool16['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?(($len1=$p['getattr'](obj, 'crumb')) === null?$constant_int_0:
							...
							(typeof $bool17=='object'?
								(typeof $bool17['__nonzero__']=='function'?
									...
									(typeof $bool17['__len__']=='function'?
										...
										true ) ) :
								 true ) )) {
						breadcrumbs['insert']($constant_int_0, $p['dict']([['label', $p['getattr'](obj, 'crumb')], ['token', obj['construct_token']()]]));
					}
					obj = $p['getattr'](obj, 'parent');
				}
				return breadcrumbs;
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('construct_event', function(params) {
				if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 1, 1, arguments['length']);
				var $bool18,$bool19,$iter2_nextval,$iter2_type,$8,$iter2_iter,param,$3,$add2,$add3,$iter2_idx,$add1,$add4,$6,$7,$4,$5,event,$iter2_array;
				event = '';
				$iter2_iter = params;
				...
				if ((($bool19=$p['op_eq']((typeof ($7=event)['__array'] != 'undefined'?
					...
					-$usub1:
					$p['op_usub']($usub1)))), '&')) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
						false :
						(typeof $bool19=='object'?
							(typeof $bool19['__nonzero__']=='function'?
								...
								(typeof $bool19['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					event = $p['__getslice'](event, 0, (typeof ($usub2=$constant_int_1)=='number'?
						-$usub2:
						$p['op_usub']($usub2)));
				}
				return event;
	...
	, 3, [null,null,['params']]);
			...
			$method = $pyjs__bind_method2('construct_token', function() {
				...
				var $and8,obj,$9,$bool24,$10,$add5,$add6,$and7,p,token,$bool21,$bool20,$bool23,$bool22,$len2,$add8,$add9,$add10,$add7;
				token = '';
				obj = self;
					...
					(typeof $bool20=='object'?
						...
						(typeof $bool21=='object'?
							(typeof $bool21['__nonzero__']=='function'?
							 ...
							 true ) )) {
					p = '';
					if ((($bool22=(($len2=$p['getattr'](obj, 'params')) === null?$constant_int_0:
						...
						(typeof $bool23['__nonzero__']=='function'?
							...
							(typeof $bool23['__len__']=='function'?
								($bool23['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$p['op_eq']((typeof ($9=token)['__array'] != 'undefined'?
					((typeof $9['__array'][$10=$constant_int_0]) != 'undefined'?$9['__array'][$10]:
						$9['__getitem__']($10)):
						$9['__getitem__']($constant_int_0)), '/'):$and7)) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
						false :
						(typeof $bool24=='object'?
							(typeof $bool24['__nonzero__']=='function'?
								...
								(typeof $bool24['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					token = $p['__getslice'](token, $constant_int_1, null);
				}
				return token;
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('deconstruct_command', function(command) {
				if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 1, 1, arguments['length']);
				var $14,$15,$16,$11,$12,$13,$bool25,$len3,attributes;
				attributes = command['$$split']('=');
				if ((($bool25=$p['op_eq']((($len3=attributes) === null?$constant_int_0:
					(typeof $len3['__array'] != 'undefined' ? new $p['int']($len3['__array']['length']):
						(typeof $len3['__len__'] == 'function'?$len3['__len__']():
							(typeof $len3['length'] != 'undefined'? new $p['int']($len3['length']):
								$p['len']($len3))))), $constant_int_1)) === null || $bool25 === false || $bool25 === 0 || $bool25 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
		...
		$m['BuoyService'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'buoy';
			$cls_definition['__md5__'] = 'dd3f232a45c2388c1736860519a979a0';
			$method = $pyjs__bind_method2('__init__', function(title, crumb) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'dd3f232a45c2388c1736860519a979a0') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timer_count', (typeof ($usub3=$constant_int_1)=='number'?
					-$usub3:
					$p['op_usub']($usub3))) : $p['setattr'](self, 'timer_count', (typeof ($usub3=$constant_int_1)=='number'?
					-$usub3:
					$p['op_usub']($usub3))); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('listeners', $p['list']([])) : $p['setattr'](self, 'listeners', $p['list']([])); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('title_listener', null) : $p['setattr'](self, 'title_listener', null); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('breadcrumbs_listener', null) : $p['setattr'](self, 'breadcrumbs_listener', null); 
				return null;
			}
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('set_titles_listener', function(listener) {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('title_listener', listener) : $p['setattr'](self, 'title_listener', listener); 
				return null;
			}
	, 1, [null,null,['self'],['listener']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('set_breadcrumbs_listener', function(listener) {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('breadcrumbs_listener', listener) : $p['setattr'](self, 'breadcrumbs_listener', listener); 
				return null;
			}
	, 1, [null,null,['self'],['listener']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('cast_off', function() {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timer_count', $constant_int_0) : $p['setattr'](self, 'timer_count', $constant_int_0); 
				$pyjs_kwargs_call(self, '_set_history_listener', null, null, [{'on_period':$constant_int_1}, true]);
				token = $m['History']['getToken']();
				if ((($bool28=(($len4=token) === null?$constant_int_0:
	...
	, 1, [null,null,['self'],['crumbs']]);
			...
			$method = $pyjs__bind_method2('onHistoryChanged', function(token) {
				...
				var $iter5_nextval,listener,first_event_keys,$17,$iter5_array,$18,$bool32,flares,$bool31,$iter5_idx,$iter5_type,$len5,$iter5_iter,events;
				var $tupleassign1 = $p['__ass_unpack'](self['_build_flares'](self, token), 2, null);
				flares = $tupleassign1[0];
				events = $tupleassign1[1];
				if ((($bool31=(($len5=events) === null?$constant_int_0:
						...
						(typeof $bool31=='object'?
							(typeof $bool31['__nonzero__']=='function'?
								...
								(typeof $bool31['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					first_event_keys = ((($bool32=$p['op_eq'](token, '#')) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
						false :
						...
						((typeof $17['__array'][$18=$constant_int_0]) != 'undefined'?$17['__array'][$18]:
							$17['__getitem__']($18)):
							$17['__getitem__']($constant_int_0))['keys']()));
	...
	, 1, [null,null,['self'],['token']]);
			...
			$method = $pyjs__bind_method2('_build_flares', function(service, token) {
				...
				while (typeof ($iter6_nextval=($iter6_type?($iter6_type > 0?$iter6_iter.next(true,false):$p['wrapped_next']($iter6_iter)):$iter6_array[$iter6_idx++])) != 'undefined') {
					event = $iter6_nextval;
					obj['__is_instance__'] && typeof obj['__setattr__'] == 'function' ? obj['__setattr__']('flare', $m['Flare']()) : $p['setattr'](obj, 'flare', $m['Flare']()); 
	...
	, 1, [null,null,['self'],['service'],['token']]);
			...
			$method = $pyjs__bind_method2('_set_history_listener', function(on, on_period) {
				...
				if ((($bool33=on) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
						...
						(typeof $bool33=='object'?
							(typeof $bool33['__nonzero__']=='function'?
								...
								(typeof $bool33['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timer', $m['Timer'](on_period, self)) : $p['setattr'](self, 'timer', $m['Timer'](on_period, self)); 
				}
				else {
					if ((($bool34=$p['op_eq']($p['getattr'](self, 'timer_count'), $constant_int_1)) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
							false :
					...
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timer_count', (typeof ($sub1=$p['getattr'](self, 'timer_count'))==typeof ($sub2=$constant_int_1) && (typeof $sub1=='number'||typeof $sub1=='string')?
						$sub1-$sub2:
						$p['op_sub']($sub1,$sub2))) : $p['setattr'](self, 'timer_count', (typeof ($sub1=$p['getattr'](self, 'timer_count'))==typeof ($sub2=$constant_int_1) && (typeof $sub1=='number'||typeof $sub1=='string')?
						$sub1-$sub2:
						$p['op_sub']($sub1,$sub2))); 
				}
				return null;
			}
	, 1, [null,null,['self'],['on'],['on_period', $constant_int_251]]);
			...
			$method = $pyjs__bind_method2('onTimer', function(id) {
				...
				var $bool35,$add12,$add11;
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('timer_count', (typeof ($add11=$p['getattr'](self, 'timer_count'))==typeof ($add12=$constant_int_1) && (typeof $add11=='number'||typeof $add11=='string')?
					$add11+$add12:
					$p['op_add']($add11,$add12))) : $p['setattr'](self, 'timer_count', (typeof ($add11=$p['getattr'](self, 'timer_count'))==typeof ($add12=$constant_int_1) && (typeof $add11=='number'||typeof $add11=='string')?
					$add11+$add12:
					$p['op_add']($add11,$add12))); 
				if ((($bool35=$p['op_eq']($p['getattr'](self, 'timer_count'), $constant_int_1)) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
						false :
