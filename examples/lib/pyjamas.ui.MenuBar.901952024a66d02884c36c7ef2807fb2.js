...
$pyjs['loaded_modules']['pyjamas.ui.MenuBar'] = function (__mod_name__) {
	...
	try {
		...
		$m['MenuBar'] = (function(){
			...
			$cls_definition['__md5__'] = '2a1fe3a60d12d0b4e811edbb41887d96';
			...
			$method = $pyjs__bind_method2('__init__', function(vertical) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '2a1fe3a60d12d0b4e811edbb41887d96') {
	...
	, 1, [null,['kwargs'],['self'],['StyleName']]);
			...
			$method = $pyjs__bind_method2('insertItem', function(item, index) {
				...
				var $bool17,tr;
				if ((($bool17=$p['getattr'](self, 'vertical')) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
						false :
	...
	, 1, [null,null,['self'],['item'],['index']]);
			...
			$method = $pyjs__bind_method2('addItem', function(item, asHTML, popup) {
				...
				var $bool18,$bool19,tr,$bool20;
				if ((($bool19=!(($bool18=$p['hasattr'](item, 'setSubMenu')) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
					false :
				...
				if ((($bool20=$p['getattr'](self, 'vertical')) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
						false :
	...
	, 1, [null,null,['self'],['item'],['asHTML', null],['popup', null]]);
			...
			$method = $pyjs__bind_method2('clearItems', function() {
				...
				var $cmp5,$bool21,$cmp6,container;
				container = self['getItemContainerElement']();
				while ((($bool21=((($cmp5=$m['DOM']['getChildCount'](container))===($cmp6=$constant_int_0)?0:
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
				...
				var $bool24,$bool25,item,$bool23,$bool22,type;
				$m['Widget']['onBrowserEvent'](self, event);
				item = self['findItem']($m['DOM']['eventGetTarget'](event));
				if ((($bool22=$p['op_is'](item, null)) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
						false :
				...
				if ((($bool23=$p['op_eq'](type, 'click')) === null || $bool23 === false || $bool23 === 0 || $bool23 === '' ?
						false :
				...
				else if ((($bool24=$p['op_eq'](type, 'mouseover')) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
						false :
				...
				else if ((($bool25=$p['op_eq'](type, 'mouseout')) === null || $bool25 === false || $bool25 === 0 || $bool25 === '' ?
						false :
	...
	, 1, [null,null,['self'],['event']]);
			...
			$method = $pyjs__bind_method2('onPopupClosed', function(sender, autoClosed) {
				...
				var $bool26;
				if ((($bool26=autoClosed) === null || $bool26 === false || $bool26 === 0 || $bool26 === '' ?
						false :
	...
	, 1, [null,null,['self'],['autoOpen']]);
			...
			$method = $pyjs__bind_method2('closeAllParents', function() {
				...
				var curMenu,$and4,$and5,$bool27,$bool29,$bool28;
				curMenu = self;
				while ((($bool27=!$p['op_is'](curMenu, null)) === null || $bool27 === false || $bool27 === 0 || $bool27 === '' ?
						false :
						(typeof $bool27=='object'?
							(typeof $bool27['__nonzero__']=='function'?
							 ...
							 true ) )) {
					curMenu['close']();
					if ((($bool29=((($bool28=$and4=$p['op_is']($p['getattr'](curMenu, 'parentMenu'), null)) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
						false :
							...
							(typeof $bool28['__nonzero__']=='function'?
								...
								(typeof $bool28['__len__']=='function'?
									($bool28['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?!$p['op_is']($p['getattr'](curMenu, 'selectedItem'), null):$and4)) === null || $bool29 === false || $bool29 === 0 || $bool29 === '' ?
							false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('doItemAction', function(item, fireCommand) {
				...
				var $sub3,$sub2,$sub1,$sub4,sub_menu,$and6,$and7,$add10,cmd,$bool32,$bool33,$bool30,$bool31,$bool36,$add7,$bool34,$bool35,$add8,$add9;
				if ((($bool31=((($bool30=$and6=!$p['op_is']($p['getattr'](self, 'shownChildMenu'), null)) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
					false :
						...
						(typeof $bool30['__nonzero__']=='function'?
							...
							(typeof $bool30['__len__']=='function'?
								($bool30['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$p['op_eq'](item['getSubMenu'](), $p['getattr'](self, 'shownChildMenu')):$and6)) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
						false :
				...
				if ((($bool32=!$p['op_is']($p['getattr'](self, 'shownChildMenu'), null)) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
						false :
				...
				if ((($bool33=$p['op_is'](item['getSubMenu'](), null)) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
						false :
						(typeof $bool33=='object'?
							(typeof $bool33['__nonzero__']=='function'?
								...
								(typeof $bool33['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool34=fireCommand) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
							false :
						...
						self['closeAllParents']();
						cmd = item['getCommand']();
						if ((($bool35=!$p['op_is'](cmd, null)) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
								false :
				...
				if ((($bool36=$p['getattr'](self, 'vertical')) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
						false :
	...
	, 1, [null,null,['self'],['item'],['fireCommand']]);
			...
			$method = $pyjs__bind_method2('onDetach', function() {
				...
				var $bool37;
				if ((($bool37=!$p['op_is']($p['getattr'](self, 'popup'), null)) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('itemOver', function(item) {
				...
				var $or5,$or7,$or6,$bool43,$bool42,$bool41,$bool40,$bool45,$bool44,$bool38,$bool39;
				if ((($bool38=$p['op_is'](item, null)) === null || $bool38 === false || $bool38 === 0 || $bool38 === '' ?
						false :
						(typeof $bool38=='object'?
							(typeof $bool38['__nonzero__']=='function'?
								...
								(typeof $bool38['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool39=!$p['op_is']($p['getattr'](self, 'selectedItem'), null)) === null || $bool39 === false || $bool39 === 0 || $bool39 === '' ?
							false :
							(typeof $bool39=='object'?
								(typeof $bool39['__nonzero__']=='function'?
									...
									(typeof $bool39['__len__']=='function'?
										...
										true ) ) :
								 true ) )) {
						if ((($bool40=!$p['op_eq'](self['selectedItem']['getSubMenu'](), null)) === null || $bool40 === false || $bool40 === 0 || $bool40 === '' ?
								false :
								(typeof $bool40=='object'?
									(typeof $bool40['__nonzero__']=='function'?
										...
										(typeof $bool40['__len__']=='function'?
											...
											true ) ) :
									 true ) )) {
							if ((($bool41=$p['op_eq']($p['getattr'](self, 'shownChildMenu'), self['selectedItem']['getSubMenu']())) === null || $bool41 === false || $bool41 === 0 || $bool41 === '' ?
									false :
				...
				self['selectItem'](item);
				if ((($bool42=!$p['op_is'](item, null)) === null || $bool42 === false || $bool42 === 0 || $bool42 === '' ?
						false :
						(typeof $bool42=='object'?
							(typeof $bool42['__nonzero__']=='function'?
								...
								(typeof $bool42['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool45=((($bool43=$or5=!$p['op_is']($p['getattr'](self, 'shownChildMenu'), null)) === null || $bool43 === false || $bool43 === 0 || $bool43 === '' ?
						false :
							...
							(typeof $bool43['__nonzero__']=='function'?
								...
								(typeof $bool43['__len__']=='function'?
									($bool43['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$or5:((($bool44=$or6=!$p['op_is']($p['getattr'](self, 'parentMenu'), null)) === null || $bool44 === false || $bool44 === 0 || $bool44 === '' ?
						false :
							...
							(typeof $bool44['__nonzero__']=='function'?
								...
								(typeof $bool44['__len__']=='function'?
									($bool44['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$or6:$p['getattr'](self, 'autoOpen')))) === null || $bool45 === false || $bool45 === 0 || $bool45 === '' ?
							false :
	...
	, 1, [null,null,['self'],['item']]);
			...
			$method = $pyjs__bind_method2('close', function() {
				...
				var $bool46;
				if ((($bool46=!$p['op_is']($p['getattr'](self, 'parentMenu'), null)) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('findItem', function(hItem) {
				...
				var $bool47,$iter3_idx,$iter3_type,item,$iter3_iter,$iter3_array,$iter3_nextval;
				...
				while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
					item = $iter3_nextval;
					if ((($bool47=$m['DOM']['isOrHasChild'](item['getElement'](), hItem)) === null || $bool47 === false || $bool47 === 0 || $bool47 === '' ?
							false :
	...
	, 1, [null,null,['self'],['hItem']]);
			...
			$method = $pyjs__bind_method2('getItemContainerElement', function() {
				...
				var $bool48;
				if ((($bool48=$p['getattr'](self, 'vertical')) === null || $bool48 === false || $bool48 === 0 || $bool48 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onHide', function() {
				...
				var $bool49;
				if ((($bool49=!$p['op_is']($p['getattr'](self, 'shownChildMenu'), null)) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onShow', function() {
				...
				var $cmp7,$bool50,$11,$12,$cmp8,$len1;
				if ((($bool50=((($cmp7=(($len1=$p['getattr'](self, 'items')) === null?$constant_int_0:
					...
					(typeof $cmp7==typeof $cmp8 && ((typeof $cmp7 == 'number')||(typeof $cmp7 == 'string')||(typeof $cmp7 == 'boolean'))?
						...
						$p['cmp']($cmp7, $cmp8))) == 1)) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('selectItem', function(item) {
				...
				var $bool51,$bool52,$bool53;
				if ((($bool51=$p['op_eq'](item, $p['getattr'](self, 'selectedItem'))) === null || $bool51 === false || $bool51 === 0 || $bool51 === '' ?
						false :
				...
				if ((($bool52=!$p['op_is']($p['getattr'](self, 'selectedItem'), null)) === null || $bool52 === false || $bool52 === 0 || $bool52 === '' ?
						false :
				...
				if ((($bool53=!$p['op_is'](item, null)) === null || $bool53 === false || $bool53 === 0 || $bool53 === '' ?
						false :
