...
$pyjs.loaded_modules['pyjamas.ui.Composite'] = function (__mod_name__) {
	...
	try {
		...
		$m['Composite'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function(widget) {
				...
				if ((($bool1=!$p['op_is'](widget, null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
	...
	, 1, [null,['kwargs'],['self'],['widget', null]]);
			...
			$method = $pyjs__bind_method2('initWidget', function(widget) {
				...
				var $bool2;
				if ((($bool2=!$p['op_is']($p['getattr'](self, 'widget'), null)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
						false :
						(typeof $bool2=='object'?
	...
	, 1, [null,null,['self'],['widget']]);
			...
			$method = $pyjs__bind_method2('isAttached', function() {
				...
				var $bool3;
				if ((($bool3=!$p['op_is']($p['getattr'](self, 'widget'), null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
