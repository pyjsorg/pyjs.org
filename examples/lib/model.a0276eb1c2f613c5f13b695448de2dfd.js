...
$pyjs['loaded_modules']['model'] = function (__mod_name__) {
	...
	try {
		...
		$m['UserProxy'] = (function(){
			...
			$cls_definition['__md5__'] = 'bb34e75545613c2d9abcded053a59bb3';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'bb34e75545613c2d9abcded053a59bb3') {
	...
	, 1, [null,null,['self'],['user']]);
		...
		$m['RoleProxy'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'model';
			$cls_definition['__md5__'] = '0262e95b38f8cf953abeece8ba4bd7cd';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0262e95b38f8cf953abeece8ba4bd7cd') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
