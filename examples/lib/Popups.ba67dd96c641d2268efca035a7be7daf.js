...
$pyjs.loaded_modules['Popups'] = function (__mod_name__) {
	...
	try {
		...
		$m['Popups'] = (function(){
			...
			$cls_definition.__md5__ = '93b54e309f90876e7b5a684fd6a0d249';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '93b54e309f90876e7b5a684fd6a0d249') {
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$m['MyDialog'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'Popups';
			$cls_definition.__md5__ = '56bceb763f378ed8728b34e620c04d5d';
			$method = $pyjs__bind_method2('__init__', function(baseURL) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '56bceb763f378ed8728b34e620c04d5d') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$m['MyDialogWindow'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'Popups';
			$cls_definition.__md5__ = '0b9910141ea933b89b1a95f0a97f98a8';
			...
			$method = $pyjs__bind_method2('__init__', function(baseURL) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '0b9910141ea933b89b1a95f0a97f98a8') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$m['MyPopup'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'Popups';
			$cls_definition.__md5__ = 'bcb80afe511aa8a2b3e0ff3c5284d155';
			$method = $pyjs__bind_method2('__init__', function() {
				if (this.__is_instance__ === true) {
					var self = this;
					if ($pyjs.options.arg_count && arguments.length != 0) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length+1);
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'bcb80afe511aa8a2b3e0ff3c5284d155') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
