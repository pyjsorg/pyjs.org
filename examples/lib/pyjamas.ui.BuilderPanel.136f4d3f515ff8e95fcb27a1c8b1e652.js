...
$pyjs.loaded_modules['pyjamas.ui.BuilderPanel'] = function (__mod_name__) {
	...
	try {
		...
		$m['BuilderPanel'] = (function(){
			...
			$cls_definition.__md5__ = '3e8f377244b9f73aa7085515b66208de';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '3e8f377244b9f73aa7085515b66208de') {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('panel_instance_name', null) : $p['setattr'](self, 'panel_instance_name', null); 
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('setPanelInstanceName', function(panel_instance_name) {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('panel_instance_name', panel_instance_name) : $p['setattr'](self, 'panel_instance_name', panel_instance_name); 
				return null;
			}
	, 1, [null,null,['self'],['panel_instance_name']]);
			...
			$method = $pyjs__bind_method2('getPanel', function() {
				...
				if ((($bool1=$p['op_is']($p['getattr'](self, 'panel_instance_name'), null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
