...
$pyjs.loaded_modules['Mailboxes'] = function (__mod_name__) {
	...
	try {
		...
		$m['Mailboxes'] = (function(){
			...
			$cls_definition.__md5__ = 'f557408f349075fd48a8a8ec1fda5c84';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'f557408f349075fd48a8a8ec1fda5c84') {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('tree', $m['Tree']()) : $p['setattr'](self, 'tree', $m['Tree']()); 
