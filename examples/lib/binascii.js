...
$pyjs.loaded_modules['binascii'] = function (__mod_name__) {
	...
	return $collcomp2;}();
			return (typeof ($add19=(typeof ($add17=$p['chr']((typeof ($add15=$p['ord'](' '))==typeof ($add16=$p['op_bitand2'](length, $constant_int_63)) && (typeof $add15=='number'||typeof $add15=='string')?
				$add15+$add16:
		...
		$m['a2b_base64'] = function(s) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $bool18,$bool19,$sub20,$bool12,$bool13,$bool14,$bool15,$bool16,$bool17,$or6,$iter4_type,$or1,$iter4_iter,$sub18,res,$add23,$add25,$add24,$add26,$bool21,$bool20,$bool23,$bool22,quad_pos,next_c,$or5,$or4,$sub19,leftchar,next_valid_char,$or3,$or2,$and1,$and2,$33,$sub17,$cmp7,$cmp11,$cmp10,$cmp12,$bool8,$bool9,c,i,$iter4_nextval,$34,$cmp9,$cmp8,$iter4_idx,leftbits,$iter4_array;
	...
	return $collcomp4;}();
		...
		$m['hex'] = function(n) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var arr,$iter7_type,$bool86,$bool85,$109,$iter7_iter,hex_gen,nibble,$add91,$add92,sign,$add94,$add93,$cmp39,$iter7_idx,$110,$cmp40,$iter7_nextval,$iter7_array;
		...
		$m['a2b_hqx'] = function(s) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $117,$iter10_nextval,$118,quadruples_gen,$138,$139,$140,done,result,$130,$131,$iter10_iter,$133,$134,$132,$136,$137,$120,$iter10_idx,$135,snippet,$pyjs_try_err,iterlist,$129,$128,$123,$122,$121,$119,$127,$126,$125,$124,$bool92,$bool93,$bool94,$len17,$iter10_array,length,$iter10_type;
			result = $p['list']([]);
			quadruples_gen = function(s) {
				if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
				var $116,$bool90,c,$115,$len16,$iter9_iter,res,$bool89,$bool88,$iter9_nextval,$iter9_idx,$iter9_array,t,iterlist,$bool91,$iter9_type;
				t = $p['list']([]);
				iterlist = $p['list']([]);
				$iter9_iter = s;
		...
		$m['b2a_hqx'] = function(s) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $172,$173,$iter11_array,$186,$174,$153,$176,$177,$156,result,$154,$155,$158,$159,$178,$179,$189,snippet,$188,$191,$181,$180,$183,$iter11_idx,$185,$184,$187,$175,$iter11_iter,$171,$167,$166,$165,$164,$163,$162,$161,$160,$iter11_nextval,$169,$168,$182,$bool96,$bool97,$len18,$iter11_type,$bool98,length,$170,$194,triples_gen,$192,$193,$190,$157;
			result = $p['list']([]);
			triples_gen = function(s) {
				if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
		...
		$m['rlecode_hqx'] = function(s) {
			if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 1, 1, arguments.length);
			var $mul8,$iter13_idx,$cmp42,$cmp43,$cmp41,$cmp44,$add104,$and41,$and40,prev,$iter13_array,$add101,$add100,$add103,$add102,$add99,$200,$bool105,$bool104,$bool107,$bool106,$bool101,$bool100,$bool103,$bool102,$mul7,$mul6,$mul5,$bool108,count,c,$iter13_nextval,$iter13_iter,$bool99,$iter13_type,$198,$199,$197,result;
