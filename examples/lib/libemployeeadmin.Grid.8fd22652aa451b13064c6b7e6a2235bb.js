/* start module: libemployeeadmin.Grid */
$pyjs['loaded_modules']['libemployeeadmin.Grid'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libemployeeadmin.Grid']['__was_initialized__']) return $pyjs['loaded_modules']['libemployeeadmin.Grid'];
	...
	var $m = $pyjs['loaded_modules']['libemployeeadmin.Grid'];
	$m['__repr__'] = function() { return '<module: libemployeeadmin.Grid>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libemployeeadmin.Grid';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libemployeeadmin']['Grid'] = $pyjs['loaded_modules']['libemployeeadmin.Grid'];
	try {

		var $constant_int_0 = new $p['int'](0);
		var $constant_int_1 = new $p['int'](1);
		$m['pyjamas'] = $p['___import___']('pyjamas.ui.Grid', 'libemployeeadmin');
		$m['Grid'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.Grid';
			$cls_definition['__md5__'] = '93ffb82926ea88aba5238c23a1d44e88';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '93ffb82926ea88aba5238c23a1d44e88') {
	...
	return this;
}; /* end libemployeeadmin.Grid */


/* end module: libemployeeadmin.Grid */
