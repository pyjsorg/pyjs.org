/* start module: libtimesheet.view.components.TimeGrid */
$pyjs['loaded_modules']['libtimesheet.view.components.TimeGrid'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.components.TimeGrid']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.components.TimeGrid'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.components.TimeGrid'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.components.TimeGrid>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.components.TimeGrid';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view.components']['TimeGrid'] = $pyjs['loaded_modules']['libtimesheet.view.components.TimeGrid'];
	try {
		...
		$m['Grid'] = $p['___import___']('Grid.Grid', 'libtimesheet.view.components', null, false);
		$m['TimeVO'] = $p['___import___']('libtimesheet.model.vo.TimeVO.TimeVO', 'libtimesheet.view.components', null, false);
		$m['TimeGrid'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.components.TimeGrid';
			$cls_definition['__md5__'] = 'f5f09c236e5724a06e99f053922707df';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'f5f09c236e5724a06e99f053922707df') {
	...
	return this;
}; /* end libtimesheet.view.components.TimeGrid */


/* end module: libtimesheet.view.components.TimeGrid */


/*
PYJS_DEPS: ['libtimesheet.ApplicationConstants.Notification', 'libtimesheet', 'libtimesheet.ApplicationConstants', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.FlexTable.FlexTable', 'pyjamas.ui.FlexTable', 'pyjamas.ui.Label.Label', 'pyjamas.ui.Label', 'pyjamas.ui.TextBox.TextBox', 'pyjamas.ui.TextBox', 'Grid.Grid', 'Grid', 'libtimesheet.model.vo.TimeVO.TimeVO', 'libtimesheet.model', 'libtimesheet.model.vo', 'libtimesheet.model.vo.TimeVO']
*/
