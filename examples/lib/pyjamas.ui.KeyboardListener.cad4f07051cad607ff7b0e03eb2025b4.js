...
$pyjs['loaded_modules']['pyjamas.ui.KeyboardListener'] = function (__mod_name__) {
	...
	try {
		...
		$m['fireKeyboardEvent'] = function(listeners, sender, event) {
			...
			var $iter3_type,$iter1_iter,$iter2_type,$iter3_idx,$iter2_iter,$iter3_nextval,$iter3_iter,type,$iter3_array,$iter1_array,$iter1_nextval,listener,$iter2_idx,$iter2_nextval,$bool6,$bool4,$bool5,keycode,$iter1_type,modifiers,$iter1_idx,$iter2_array;
			modifiers = $m['getKeyboardModifiers'](event);
			keycode = $m['DOM']['eventGetKeyCode'](event);
			type = $m['DOM']['eventGetType'](event);
			if ((($bool4=$p['op_eq'](type, 'keydown')) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
					false :
					(typeof $bool4=='object'?
			...
			else if ((($bool5=$p['op_eq'](type, 'keyup')) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
					false :
					(typeof $bool5=='object'?
			...
			else if ((($bool6=$p['op_eq'](type, 'keypress')) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
					false :
					(typeof $bool6=='object'?
