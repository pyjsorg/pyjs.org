...
$pyjs['loaded_modules']['pyjamas.ui.DragHandler'] = function (__mod_name__) {
	...
	try {
		...
		$m['fireDragEvent'] = function(listeners, event) {
			...
			var $iter3_type,$iter1_iter,$iter2_type,$iter3_idx,$iter2_iter,$iter3_nextval,$iter3_iter,etype,$iter1_array,$iter1_nextval,$bool2,$bool3,$iter2_idx,$bool1,$iter3_array,listener,$iter2_nextval,$iter1_type,$iter1_idx,$iter2_array;
			etype = $m['DOM']['eventGetType'](event);
			if ((($bool1=$p['op_eq'](etype, 'dragstart')) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
			...
			else if ((($bool2=$p['op_eq'](etype, 'drag')) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
			...
			else if ((($bool3=$p['op_eq'](etype, 'dragend')) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
					false :
					(typeof $bool3=='object'?
