...
$pyjs.loaded_modules['pyjamas.ui.RootPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$m['get'] = function(id) {
			...
			element = null;
			if ((($bool2=!$p['op_is'](id, null)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
				...
				if ((($bool3=$p['op_is'](element, null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
		...
		$m['manageRootPanel'] = function(panel, id) {
			...
			if ((($bool4=((($cmp1=(($len1=$m['rootPanels']) === null?$constant_int_0:
		...
		$m['RootPanelCls'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function(Element) {
				...
				var $bool6,$bool5;
				if ((($bool5=!$p['op_is'](Element, null)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
				...
				if ((($bool6=$p['op_is'](Element, null)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
						false :
						(typeof $bool6=='object'?
