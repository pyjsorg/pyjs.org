...
$pyjs.loaded_modules['DynaTableWidget'] = function (__mod_name__) {
	...
	try {
		...
		$m['NavBar'] = (function(){
			...
			$cls_definition.__md5__ = '9554f00e92244ea7c4e2a310f5935223';
			$method = $pyjs__bind_method2('__init__', function(owner) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '9554f00e92244ea7c4e2a310f5935223') {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('bar', $m['DockPanel']()) : $p['setattr'](self, 'bar', $m['DockPanel']()); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('gotoFirst', $m['Button']('&lt;&lt;', self)) : $p['setattr'](self, 'gotoFirst', $m['Button']('&lt;&lt;', self)); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('gotoNext', $m['Button']('&gt;', self)) : $p['setattr'](self, 'gotoNext', $m['Button']('&gt;', self)); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('gotoPrev', $m['Button']('&lt;', self)) : $p['setattr'](self, 'gotoPrev', $m['Button']('&lt;', self)); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('status', $m['HTML']()) : $p['setattr'](self, 'status', $m['HTML']()); 
	...
	, 1, [null,null,['self'],['owner']]);
			...
			$method = $pyjs__bind_method2('onClick', function(sender) {
				...
				var $bool2,$cmp1,$cmp2,$add2,$bool3,$bool1,$bool4,$sub2,$sub1,$add1;
				if ((($bool1=$p['op_eq'](sender, $p['getattr'](self, 'gotoNext'))) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
							(typeof $bool1.__nonzero__=='function'?
								...
								(typeof $bool1.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					$p['getattr'](self, 'owner').__is_instance__ && typeof $p['getattr'](self, 'owner').__setattr__ == 'function' ? $p['getattr'](self, 'owner').__setattr__('startRow', (typeof ($add1=$p['getattr']($p['getattr'](self, 'owner'), 'startRow'))==typeof ($add2=self['owner']['getDataRowCount']()) && (typeof $add1=='number'||typeof $add1=='string')?
						$add1+$add2:
						$p['op_add']($add1,$add2))) : $p['setattr']($p['getattr'](self, 'owner'), 'startRow', (typeof ($add1=$p['getattr']($p['getattr'](self, 'owner'), 'startRow'))==typeof ($add2=self['owner']['getDataRowCount']()) && (typeof $add1=='number'||typeof $add1=='string')?
						$add1+$add2:
						$p['op_add']($add1,$add2))); 
					self['owner']['refresh']();
				}
				else if ((($bool2=$p['op_eq'](sender, $p['getattr'](self, 'gotoPrev'))) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
						false :
						(typeof $bool2=='object'?
							(typeof $bool2.__nonzero__=='function'?
								...
								(typeof $bool2.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					$p['getattr'](self, 'owner').__is_instance__ && typeof $p['getattr'](self, 'owner').__setattr__ == 'function' ? $p['getattr'](self, 'owner').__setattr__('startRow', (typeof ($sub1=$p['getattr']($p['getattr'](self, 'owner'), 'startRow'))==typeof ($sub2=self['owner']['getDataRowCount']()) && (typeof $sub1=='number'||typeof $sub1=='string')?
						$sub1-$sub2:
						$p['op_sub']($sub1,$sub2))) : $p['setattr']($p['getattr'](self, 'owner'), 'startRow', (typeof ($sub1=$p['getattr']($p['getattr'](self, 'owner'), 'startRow'))==typeof ($sub2=self['owner']['getDataRowCount']()) && (typeof $sub1=='number'||typeof $sub1=='string')?
						$sub1-$sub2:
						$p['op_sub']($sub1,$sub2))); 
					if ((($bool3=((($cmp1=$p['getattr']($p['getattr'](self, 'owner'), 'startRow'))===($cmp2=$constant_int_0)?0:
							...
							(typeof $bool3=='object'?
								(typeof $bool3.__nonzero__=='function'?
									...
									(typeof $bool3.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						$p['getattr'](self, 'owner').__is_instance__ && typeof $p['getattr'](self, 'owner').__setattr__ == 'function' ? $p['getattr'](self, 'owner').__setattr__('startRow', $constant_int_0) : $p['setattr']($p['getattr'](self, 'owner'), 'startRow', $constant_int_0); 
					}
					self['owner']['refresh']();
				}
				else if ((($bool4=$p['op_eq'](sender, $p['getattr'](self, 'gotoFirst'))) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$m['RowDataAcceptorImpl'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'DynaTableWidget';
			$cls_definition.__md5__ = '3498c50ad709e0db54246fa0c73aed9f';
			$method = $pyjs__bind_method2('__init__', function(owner) {
				if (this.__is_instance__ === true) {
					var self = this;
					if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 2, 2, arguments.length+1);
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '3498c50ad709e0db54246fa0c73aed9f') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['owner']]);
			...
			$method = $pyjs__bind_method2('accept', function(startRow, data) {
				...
				destColCount = self['owner']['grid']['getCellCount']($constant_int_0);
				srcRowIndex = $constant_int_0;
				srcRowCount = (($len1=data) === null?$constant_int_0:
					(typeof $len1.__array != 'undefined' ? new $p['int']($len1.__array.length):
						(typeof $len1.__len__ == 'function'?$len1.__len__():
							(typeof $len1.length != 'undefined'? new $p['int']($len1.length):
								$p['len']($len1)))));
				destRowIndex = $constant_int_1;
				while ((($bool5=((($cmp3=srcRowIndex)===($cmp4=srcRowCount)?0:
					...
					srcRowIndex = (typeof ($add3=srcRowIndex)==typeof ($add4=$constant_int_1) && (typeof $add3=='number'||typeof $add3=='string')?
						$add3+$add4:
						$p['op_add']($add3,$add4));
					destRowIndex = (typeof ($add5=destRowIndex)==typeof ($add6=$constant_int_1) && (typeof $add5=='number'||typeof $add5=='string')?
						$add5+$add6:
						$p['op_add']($add5,$add6));
				}
				isLastPage = false;
				while ((($bool6=((($cmp5=destRowIndex)===($cmp6=(typeof ($add7=destRowCount)==typeof ($add8=$constant_int_1) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					...
					destRowIndex = (typeof ($add9=destRowIndex)==typeof ($add10=$constant_int_1) && (typeof $add9=='number'||typeof $add9=='string')?
						$add9+$add10:
						$p['op_add']($add9,$add10));
				}
					...
					(typeof $bool7=='object'?
						(typeof $bool7.__nonzero__=='function'?
							...
							(typeof $bool7.__len__=='function'?
								...
								true ) ) :
						 true ) ));
				self['owner']['navbar']['gotoFirst']['setEnabled'](((($cmp7=startRow)===($cmp8=$constant_int_0)?0:
					(typeof $cmp7==typeof $cmp8 && ((typeof $cmp7 == 'number')||(typeof $cmp7 == 'string')||(typeof $cmp7 == 'boolean'))?
						($cmp7 == $cmp8 ? 0 : ($cmp7 < $cmp8 ? -1 : 1)):
						$p['cmp']($cmp7, $cmp8))) == 1));
				self['owner']['navbar']['gotoPrev']['setEnabled'](((($cmp9=startRow)===($cmp10=$constant_int_0)?0:
					(typeof $cmp9==typeof $cmp10 && ((typeof $cmp9 == 'number')||(typeof $cmp9 == 'string')||(typeof $cmp9 == 'boolean'))?
						($cmp9 == $cmp10 ? 0 : ($cmp9 < $cmp10 ? -1 : 1)):
						$p['cmp']($cmp9, $cmp10))) == 1));
				self['owner']['setStatusText']((typeof ($add17=(typeof ($add13=$p['str']((typeof ($add11=startRow)==typeof ($add12=$constant_int_1) && (typeof $add11=='number'||typeof $add11=='string')?
					$add11+$add12:
	...
	, 1, [null,null,['self'],['message']]);
		...
		$m['DynaTableWidget'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'DynaTableWidget';
			$cls_definition.__md5__ = '8b5e9f60d66985729caabbda5ab8b240';
			$method = $pyjs__bind_method2('__init__', function(provider, columns, columnStyles, rowCount) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '8b5e9f60d66985729caabbda5ab8b240') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				$m['Composite']['__init__'](self);
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('acceptor', $m['RowDataAcceptorImpl'](self)) : $p['setattr'](self, 'acceptor', $m['RowDataAcceptorImpl'](self)); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('outer', $m['DockPanel']()) : $p['setattr'](self, 'outer', $m['DockPanel']()); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('startRow', $constant_int_0) : $p['setattr'](self, 'startRow', $constant_int_0); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('grid', $m['Grid']()) : $p['setattr'](self, 'grid', $m['Grid']()); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('navbar', $m['NavBar'](self)) : $p['setattr'](self, 'navbar', $m['NavBar'](self)); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('provider', provider) : $p['setattr'](self, 'provider', provider); 
	...
	, 1, [null,null,['self'],['provider'],['columns'],['columnStyles'],['rowCount']]);
			...
			$method = $pyjs__bind_method2('initTable', function(columns, columnStyles, rowCount) {
				...
				self['grid']['resize']((typeof ($add19=rowCount)==typeof ($add20=$constant_int_1) && (typeof $add19=='number'||typeof $add19=='string')?
					$add19+$add20:
					$p['op_add']($add19,$add20)), (($len2=columns) === null?$constant_int_0:
					(typeof $len2.__array != 'undefined' ? new $p['int']($len2.__array.length):
						(typeof $len2.__len__ == 'function'?$len2.__len__():
							(typeof $len2.length != 'undefined'? new $p['int']($len2.length):
								$p['len']($len2))))));
				$iter3_iter = $p['range']((($len3=columns) === null?$constant_int_0:
				...
				while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
					i = $iter3_nextval;
					self['grid']['setText']($constant_int_0, i, (typeof ($5=columns).__array != 'undefined'?
							...
							(typeof $bool9=='object'?
								(typeof $bool9.__nonzero__=='function'?
									...
									(typeof $bool9.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						self['grid']['cellFormatter']['setStyleName']($constant_int_0, i, (typeof ($add21=(typeof ($7=columnStyles).__array != 'undefined'?
	...
	, 1, [null,null,['self'],['text']]);
			...
			$method = $pyjs__bind_method2('refresh', function() {
				...
				self['provider']['updateRowData']($p['getattr'](self, 'startRow'), (typeof ($sub3=self['grid']['getRowCount']())==typeof ($sub4=$constant_int_1) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
	...
	, 1, [null,null,['self'],['rows']]);
			...
			$method = $pyjs__bind_method2('getDataRowCount', function() {
				...
				var $sub6,$sub5;
				return (typeof ($sub5=self['grid']['getRowCount']())==typeof ($sub6=$constant_int_1) && (typeof $sub5=='number'||typeof $sub5=='string')?
					$sub5-$sub6:
					$p['op_sub']($sub5,$sub6));
			}
	, 1, [null,null,['self']]);
