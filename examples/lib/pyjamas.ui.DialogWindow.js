...
$pyjs.loaded_modules['pyjamas.ui.DialogWindow'] = function (__mod_name__) {
	...
	try {
		...
		$m['DialogWindow'] = (function(){
			...
			$cls_definition.__md5__ = '2e77569c472b9fa26cc7b5cd571d92aa';
			...
			$method = $pyjs__bind_method2('__init__', function(autoHide, modal, centered, caption, minimize, maximize, close, captionStyle) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '2e77569c472b9fa26cc7b5cd571d92aa') {
							...
							(typeof $bool19=='object'?
								(typeof $bool19.__nonzero__=='function'?
									...
									(typeof $bool19.__len__=='function'?
										...
										true ) ) :
								 true ) )) {
						if ((($bool20=$p['op_is']($p['getattr'](listener, action)(), false)) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
								false :
	...
	, 1, [null,null,['self'],['action']]);
			...
			$method = $pyjs__bind_method2('onActivate', function() {
				...
				var $bool21;
				if ((($bool21=$p['op_is'](self['_runDialogListener']('onActivate'), false)) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onMaximize', function(sender) {
				...
				if ((($bool23=$p['op_is'](self['_runDialogListener']('onMaximize'), false)) === null || $bool23 === false || $bool23 === 0 || $bool23 === '' ?
						false :
	...
	, 1, [null,null,['self'],['sender']]);
			...
			$method = $pyjs__bind_method2('onMinimize', function(sender) {
				...
				if ((($bool26=$p['op_is'](self['_runDialogListener']('onMinimize'), false)) === null || $bool26 === false || $bool26 === 0 || $bool26 === '' ?
						false :
				...
				if ((($bool27=!$p['op_is'](widget, null)) === null || $bool27 === false || $bool27 === 0 || $bool27 === '' ?
						false :
					...
					if ((($bool28=widget['isVisible']()) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
						...
						if ((($bool30=!$p['op_is']($p['getattr'](self, '_minimized'), null)) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
								false :
	...
	, 1, [null,null,['self'],['sender']]);
			...
			$method = $pyjs__bind_method2('onClose', function(sender) {
				...
				var $bool31;
				if ((($bool31=$p['op_is'](self['_runDialogListener']('onClose'), false)) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
						false :
	...
	, 1, [null,null,['self'],['sender']]);
			...
			$method = $pyjs__bind_method2('onMouseUp', function(sender, x, y) {
				...
				var $or5,$or4,$bool32,$bool33;
				if ((($bool33=((($bool32=$or4=!$p['op_eq']($p['getattr'](self, 'dragStartX'), x)) === null || $bool32 === false || $bool32 === 0 || $bool32 === '' ?
					false :
						...
						(typeof $bool32.__nonzero__=='function'?
							...
							(typeof $bool32.__len__=='function'?
								($bool32.__len__()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or4:!$p['op_eq']($p['getattr'](self, 'dragStartY'), y))) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
						false :
