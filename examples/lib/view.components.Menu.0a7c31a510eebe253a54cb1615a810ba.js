...
$pyjs['loaded_modules']['view.components.Menu'] = function (__mod_name__) {
	...
	try {
		...
		$m['Menu'] = (function(){
			...
			$cls_definition['__md5__'] = '59c98509c21867e5ac75ae48d909446c';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '59c98509c21867e5ac75ae48d909446c') {
	...
	, 1, [null,null,['self']]);
		...
		$m['MenuCmd'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'view.components.Menu';
			$cls_definition['__md5__'] = '80e549271df618447e838063b88b7f3b';
			$method = $pyjs__bind_method2('setHandler', function(handler) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '80e549271df618447e838063b88b7f3b') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
