...
$pyjs['loaded_modules']['pyjamas.ui.TreeItem'] = function (__mod_name__) {
	...
	try {
		...
		$m['TreeItem'] = (function(){
			...
			$cls_definition['__md5__'] = '74f50de0216caf2fc60cf0916ebc8b2f';
			$method = $pyjs__bind_method2('__init__', function(html) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '74f50de0216caf2fc60cf0916ebc8b2f') {
	...
	, 1, [null,null,['self'],['mode']]);
		...
		$m['RootTreeItem'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.ui.TreeItem';
			$cls_definition['__md5__'] = '67acf2343589fe7c4b32b640830a3915';
			$method = $pyjs__bind_method2('addItem', function(item) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 2, 2, arguments['length']+1);
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '67acf2343589fe7c4b32b640830a3915') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
