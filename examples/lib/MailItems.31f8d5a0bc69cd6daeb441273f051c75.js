...
$pyjs.loaded_modules['MailItems'] = function (__mod_name__) {
	...
	try {
		...
		$m['MailItems'] = (function(){
			...
			$cls_definition.__md5__ = 'bb2495023b63e0f98c4947b116df091c';
			$cls_definition['NUM_ITEMS'] = $constant_int_37;
			$cls_definition['FRAGMENTS_PER_EMAIL'] = $constant_int_10;
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'bb2495023b63e0f98c4947b116df091c') {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('senderIdx', $constant_int_0) : $p['setattr'](self, 'senderIdx', $constant_int_0); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('emailIdx', $constant_int_0) : $p['setattr'](self, 'emailIdx', $constant_int_0); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('subjectIdx', $constant_int_0) : $p['setattr'](self, 'subjectIdx', $constant_int_0); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('fragmentIdx', $constant_int_0) : $p['setattr'](self, 'fragmentIdx', $constant_int_0); 
				...
				while ((($bool1=((($cmp1=i)===($cmp2=$p['getattr']($m['MailItems'], 'NUM_ITEMS'))?0:
					...
					i = (typeof ($add239=i)==typeof ($add240=$constant_int_1) && (typeof $add239=='number'||typeof $add239=='string')?
						$add239+$add240:
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getMailItemCount', function() {
				...
				var $len1;
				return (($len1=$p['getattr'](self, 'items')) === null?$constant_int_0:
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getMailItem', function(index) {
				...
				if ((($bool2=((((($cmp3=index)===($cmp4=(($len2=$p['getattr'](self, 'items')) === null?$constant_int_0:
	...
	, 1, [null,null,['self'],['index']]);
			...
			$method = $pyjs__bind_method2('createFakeMail', function() {
				...
				var $bool4,$9,subject,$len6,$add244,$add245,email,$add243,body,$add251,$add250,$add252,$bool3,$bool6,$bool7,$8,$bool5,$6,$7,$4,$5,$3,$cmp5,$cmp6,$10,sender,i,$add246,$add247,$len4,$len5,$add242,$len3,$add241,$add248,$add249;
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('senderIdx', (typeof ($add241=$p['getattr'](self, 'senderIdx'))==typeof ($add242=$constant_int_1) && (typeof $add241=='number'||typeof $add241=='string')?
					$add241+$add242:
					$p['op_add']($add241,$add242))) : $p['setattr'](self, 'senderIdx', (typeof ($add241=$p['getattr'](self, 'senderIdx'))==typeof ($add242=$constant_int_1) && (typeof $add241=='number'||typeof $add241=='string')?
					$add241+$add242:
					$p['op_add']($add241,$add242))); 
				if ((($bool3=$p['op_eq']($p['getattr'](self, 'senderIdx'), (($len3=$p['getattr']($m['MailItems'], 'senders')) === null?$constant_int_0:
					(typeof $len3.__array != 'undefined' ? new $p['int']($len3.__array.length):
						(typeof $len3.__len__ == 'function'?$len3.__len__():
							(typeof $len3.length != 'undefined'? new $p['int']($len3.length):
								$p['len']($len3))))))) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('emailIdx', (typeof ($add243=$p['getattr'](self, 'emailIdx'))==typeof ($add244=$constant_int_1) && (typeof $add243=='number'||typeof $add243=='string')?
					$add243+$add244:
					$p['op_add']($add243,$add244))) : $p['setattr'](self, 'emailIdx', (typeof ($add243=$p['getattr'](self, 'emailIdx'))==typeof ($add244=$constant_int_1) && (typeof $add243=='number'||typeof $add243=='string')?
					$add243+$add244:
					$p['op_add']($add243,$add244))); 
				if ((($bool4=$p['op_eq']($p['getattr'](self, 'emailIdx'), (($len4=$p['getattr']($m['MailItems'], 'emails')) === null?$constant_int_0:
					(typeof $len4.__array != 'undefined' ? new $p['int']($len4.__array.length):
						(typeof $len4.__len__ == 'function'?$len4.__len__():
							(typeof $len4.length != 'undefined'? new $p['int']($len4.length):
								$p['len']($len4))))))) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('subjectIdx', (typeof ($add245=$p['getattr'](self, 'subjectIdx'))==typeof ($add246=$constant_int_1) && (typeof $add245=='number'||typeof $add245=='string')?
					$add245+$add246:
					$p['op_add']($add245,$add246))) : $p['setattr'](self, 'subjectIdx', (typeof ($add245=$p['getattr'](self, 'subjectIdx'))==typeof ($add246=$constant_int_1) && (typeof $add245=='number'||typeof $add245=='string')?
					$add245+$add246:
					$p['op_add']($add245,$add246))); 
				if ((($bool5=$p['op_eq']($p['getattr'](self, 'subjectIdx'), (($len5=$p['getattr']($m['MailItems'], 'subjects')) === null?$constant_int_0:
					(typeof $len5.__array != 'undefined' ? new $p['int']($len5.__array.length):
						(typeof $len5.__len__ == 'function'?$len5.__len__():
							(typeof $len5.length != 'undefined'? new $p['int']($len5.length):
								$p['len']($len5))))))) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
				...
				while ((($bool6=((($cmp5=i)===($cmp6=$p['getattr']($m['MailItems'], 'FRAGMENTS_PER_EMAIL'))?0:
					...
					self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('fragmentIdx', (typeof ($add249=$p['getattr'](self, 'fragmentIdx'))==typeof ($add250=$constant_int_1) && (typeof $add249=='number'||typeof $add249=='string')?
						$add249+$add250:
						$p['op_add']($add249,$add250))) : $p['setattr'](self, 'fragmentIdx', (typeof ($add249=$p['getattr'](self, 'fragmentIdx'))==typeof ($add250=$constant_int_1) && (typeof $add249=='number'||typeof $add249=='string')?
						$add249+$add250:
						$p['op_add']($add249,$add250))); 
					if ((($bool7=$p['op_eq']($p['getattr'](self, 'fragmentIdx'), (($len6=$p['getattr']($m['MailItems'], 'fragments')) === null?$constant_int_0:
						(typeof $len6.__array != 'undefined' ? new $p['int']($len6.__array.length):
							(typeof $len6.__len__ == 'function'?$len6.__len__():
								(typeof $len6.length != 'undefined'? new $p['int']($len6.length):
									$p['len']($len6))))))) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
							false :
							(typeof $bool7=='object'?
					...
					i = (typeof ($add251=i)==typeof ($add252=$constant_int_1) && (typeof $add251=='number'||typeof $add251=='string')?
						$add251+$add252:
