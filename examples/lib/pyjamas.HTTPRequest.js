...
$pyjs['loaded_modules']['pyjamas.HTTPRequest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['sender'],['event'],['ignorearg']]);
			...
			$method = $pyjs__bind_method2('onLoad', function(sender, event, ignorearg) {
				...
				var status,localHandler,xmlHttp,$or2,$bool11,$bool13,$bool12,handler,responseText,$or1;
				xmlHttp = $p['getattr'](event, 'target');
				localHandler = $m['handlers']['get'](xmlHttp);
				...
				handler = null;
				xmlHttp = null;
				if ((($bool11=$p['op_eq'](status, $constant_int_0)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
				...
				if ((($bool13=((($bool12=$or1=$p['op_eq'](status, $constant_int_200)) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
					false :
						...
						(typeof $bool12['__nonzero__']=='function'?
							...
							(typeof $bool12['__len__']=='function'?
								($bool12['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or1:$p['op_eq'](status, $constant_int_0))) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
						false :
	...
	, 1, [null,null,['self'],['sender'],['event'],['ignorearg']]);
			...
			$method = $pyjs__bind_method2('onReadyStateChange', function(xmlHttp, event, ignorearg) {
				...
				var status,$or4,localHandler,$or3,handler,$bool14,$bool15,$bool16,$pyjs_try_err,responseText;
				try {
				...
				if ((($bool14=!$p['op_eq']($p['getattr'](xmlHttp, 'readyState'), $constant_int_4)) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
						false :
				...
				handler = null;
				xmlHttp = null;
				if ((($bool16=((($bool15=$or3=$p['op_eq'](status, $constant_int_200)) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
					false :
						...
						(typeof $bool15['__nonzero__']=='function'?
							...
							(typeof $bool15['__len__']=='function'?
								($bool15['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or3:$p['op_eq'](status, $constant_int_0))) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
						false :
	...
	, 1, [null,null,['self'],['xmlHttp'],['event'],['ignorearg']]);
			...
			$method = $pyjs__bind_method2('_convertUrlToAbsolute', function(url) {
				...
				var $bool18,$bool19,sep,$bool17,$bool21,$bool20,$bool23,$bool22,slash,$and1,$and2,$and3,$2,$1,$cmp1,$cmp2,uri,$add2,$add3,$add1,$add6,$add4,$add5;
				uri = $m['pygwt']['getModuleBaseURL']();
				if ((($bool17=$p['op_eq']((typeof ($1=url)['__array'] != 'undefined'?
					((typeof $1['__array'][$2=$constant_int_0]) != 'undefined'?$1['__array'][$2]:
						$1['__getitem__']($2)):
						$1['__getitem__']($constant_int_0)), '/')) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
						false :
					...
					if ((($bool19=!(($bool18=uri['startswith']('file://')) === null || $bool18 === false || $bool18 === 0 || $bool18 === '' ?
						...
						slash = uri['find']('/', (typeof ($add1=sep)==typeof ($add2=$constant_int_3) && (typeof $add1=='number'||typeof $add1=='string')?
							$add1+$add2:
							$p['op_add']($add1,$add2)));
						if ((($bool20=((($cmp1=slash)===($cmp2=$constant_int_0)?0:
					...
					if ((($bool23=((($bool21=$and1=!$p['op_eq']($p['__getslice'](url, 0, $constant_int_7), 'file://')) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
						false :
							...
							(typeof $bool21['__nonzero__']=='function'?
								...
								(typeof $bool21['__len__']=='function'?
									($bool21['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool22=$and2=!$p['op_eq']($p['__getslice'](url, 0, $constant_int_7), 'http://')) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
						false :
							...
							(typeof $bool22['__nonzero__']=='function'?
								...
								(typeof $bool22['__len__']=='function'?
									($bool22['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?!$p['op_eq']($p['__getslice'](url, 0, $constant_int_8), 'https://'):$and2):$and1)) === null || $bool23 === false || $bool23 === 0 || $bool23 === '' ?
							false :
	...
	, 1, [null,null,['self'],['url']]);
			...
			$method = $pyjs__bind_method2('asyncImpl', function(method, user, pwd, url, postData, handler, returnxml, content_type, headers) {
				...
				var $or5,hval,$iter1_iter,$or8,$bool33,res,base64,$bool25,$bool24,$bool27,$bool26,$iter1_array,$bool29,$bool28,$iter1_idx,$and8,$or7,$or6,$iter1_nextval,$bool40,$and4,$and5,$and6,$and7,$6,$4,$5,$3,mf,xmlHttp,$iter1_type,h,$pyjs_try_err,$bool32,$bool30,$bool31,$bool36,$bool37,$bool34,$bool35,$bool38,$bool39;
				if ((($bool24=$p['op_is'](headers, null)) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
						false :
				...
				if ((($bool29=!$p['op_is'](content_type, null)) === null || $bool29 === false || $bool29 === 0 || $bool29 === '' ?
						false :
				...
				if ((($bool33=$p['op_eq']($p['getattr'](mf, 'platform'), 'webkit')) === null || $bool33 === false || $bool33 === 0 || $bool33 === '' ?
						false :
				...
				else if ((($bool34=$p['op_eq']($p['getattr'](mf, 'platform'), 'mshtml')) === null || $bool34 === false || $bool34 === 0 || $bool34 === '' ?
						false :
				...
				if ((($bool36=((($bool35=$and7=!$p['op_eq']($p['getattr'](mf, 'platform'), 'mshtml')) === null || $bool35 === false || $bool35 === 0 || $bool35 === '' ?
					false :
						...
						(typeof $bool35['__nonzero__']=='function'?
							...
							(typeof $bool35['__len__']=='function'?
								($bool35['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?!$p['op_eq']($p['getattr'](mf, 'platform'), 'ie6'):$and7)) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
						false :
				...
				if ((($bool38=((($bool37=$or5=$p['op_eq']($p['getattr'](mf, 'platform'), 'webkit')) === null || $bool37 === false || $bool37 === 0 || $bool37 === '' ?
					false :
						...
						(typeof $bool37['__nonzero__']=='function'?
							...
							(typeof $bool37['__len__']=='function'?
								($bool37['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or5:$p['op_eq']($p['getattr'](mf, 'platform'), 'mshtml'))) === null || $bool38 === false || $bool38 === 0 || $bool38 === '' ?
						false :
