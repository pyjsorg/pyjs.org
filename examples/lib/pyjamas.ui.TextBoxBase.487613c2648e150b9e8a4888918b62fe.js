...
$pyjs.loaded_modules['pyjamas.ui.TextBoxBase'] = function (__mod_name__) {
	...
	try {
		...
		$m['TextBoxBase'] = (function(){
			...
			$cls_definition.__md5__ = 'e70b04d89b03d38a23b6a17c9d012116';
			...
			$method = $pyjs__bind_method2('__init__', function(element) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'e70b04d89b03d38a23b6a17c9d012116') {
	...
	, 2, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('cancelKey', function() {
				...
				var $bool1;
				if ((($bool1=!$p['op_is']($p['getattr'](self, 'currentEvent'), null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('selectAll', function() {
				...
				length = (($len1=self['getText']()) === null?$constant_int_0:
					(typeof $len1.__array != 'undefined' ? new $p['int']($len1.__array.length):
						(typeof $len1.__len__ == 'function'?$len1.__len__():
							(typeof $len1.length != 'undefined'? new $p['int']($len1.length):
								$p['len']($len1)))));
				if ((($bool3=((($cmp1=length)===($cmp2=$constant_int_0)?0:
	...
	, 1, [null,null,['self'],['pos']]);
			...
			$method = $pyjs__bind_method2('setKey', function(key) {
				...
				var $bool4;
				if ((($bool4=!$p['op_is']($p['getattr'](self, 'currentEvent'), null)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
	...
	, 1, [null,null,['self'],['name']]);
			...
			$method = $pyjs__bind_method2('setSelectionRange', function(pos, length) {
				...
				if ((($bool5=((($cmp3=length)===($cmp4=$constant_int_0)?0:
				...
				if ((($bool7=((($bool6=$or1=((($cmp5=pos)===($cmp6=$constant_int_0)?0:
					...
					$add7+$add8:
					$p['op_add']($add7,$add8)))===($cmp8=(($len2=self['getText']()) === null?$constant_int_0:
					...
					console['error']((typeof ($add13=(typeof ($add11=$p['sprintf']('From Index: %d ', pos))==typeof ($add12=$p['sprintf']('  To Index: %d ', (typeof ($add9=pos)==typeof ($add10=length) && (typeof $add9=='number'||typeof $add9=='string')?
						...
						$add11+$add12:
						$p['op_add']($add11,$add12)))==typeof ($add14=$p['sprintf']('  Text Length: %d ', (($len3=self['getText']()) === null?$constant_int_0:
