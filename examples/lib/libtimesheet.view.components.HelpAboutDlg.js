/* start module: libtimesheet.view.components.HelpAboutDlg */
$pyjs['loaded_modules']['libtimesheet.view.components.HelpAboutDlg'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.components.HelpAboutDlg']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.components.HelpAboutDlg'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.components.HelpAboutDlg'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.components.HelpAboutDlg>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.components.HelpAboutDlg';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view.components']['HelpAboutDlg'] = $pyjs['loaded_modules']['libtimesheet.view.components.HelpAboutDlg'];
	try {
		...
		$m['HelpAboutDlg'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.components.HelpAboutDlg';
			$cls_definition['__md5__'] = '8286f858566e185aff35fc9860c6dc83';
			$method = $pyjs__bind_method2('__init__', function(left, top) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '8286f858566e185aff35fc9860c6dc83') {
	...
	return this;
}; /* end libtimesheet.view.components.HelpAboutDlg */


/* end module: libtimesheet.view.components.HelpAboutDlg */
