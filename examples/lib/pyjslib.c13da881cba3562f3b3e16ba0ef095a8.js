...
$p['abs'] = Math['abs'];
	...
	$m['Class'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '9a36baac0eff689374e34cdd24a0b478';
		$method = $pyjs__bind_method2('__init__', function(name) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '9a36baac0eff689374e34cdd24a0b478') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['float'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '6d1ad7ad34f72ef6413434f0e1ceb629';
...
Number['prototype']['__pow__'] = function (y, z) {
	...
	$m['float'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'c503f52114c0dce52882936423d01798';
		$method = $pyjs__bind_method2('__init__', function(num) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== 'c503f52114c0dce52882936423d01798') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
(function(){
	...
	$m['tuple'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'e8bcca5c29ddf5dc1a752787e9fcf06c';
		$method = $pyjs__bind_method2('__init__', function(data) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== 'e8bcca5c29ddf5dc1a752787e9fcf06c') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['tuple']['toString'] = $m['tuple']['__str__'];
	$m['NotImplementedType'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '5c1d19c248774cbd047e50b4fd1a0fa6';
		$method = $pyjs__bind_method2('__repr__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
				if ($pyjs['options']['arg_count'] && arguments['length'] != 0) $pyjs__exception_func_param(arguments['callee']['__name__'], 1, 1, arguments['length']+1);
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '5c1d19c248774cbd047e50b4fd1a0fa6') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$enumerate_array['prototype']['$genfunc'] = $enumerate_array['prototype']['next'];
	...
	$m['list'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '4a73f0a472449202d37bb5cb4d0c2c8a';
		$method = $pyjs__bind_method2('__init__', function(data) {
			if (this['__is_instance__'] === true) {
				var self = this;
				if ($pyjs['options']['arg_count'] && (arguments['length'] < 0 || arguments['length'] > 1)) $pyjs__exception_func_param(arguments['callee']['__name__'], 1, 2, arguments['length']+1);
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '4a73f0a472449202d37bb5cb4d0c2c8a') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['list']['toString'] = $m['list']['__str__'];
	$m['slice'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '7397c6ce240a28879742c8fb14132cdd';
		$method = $pyjs__bind_method2('__init__', function(a1) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '7397c6ce240a28879742c8fb14132cdd') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['slice']['toString'] = $m['slice']['__str__'];
	$m['dict'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'c40520ac28f6f6df1b378fdff8bfa132';
		$method = $pyjs__bind_method2('__init__', function(seq) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== 'c40520ac28f6f6df1b378fdff8bfa132') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['dict']['__str__'] = $m['dict']['__repr__'];
	...
	$m['set'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'c1aacb312ad0441b375afb33378aa59e';
		$method = $pyjs__bind_method2('__init__', function(_data) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== 'c1aacb312ad0441b375afb33378aa59e') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['set']['toString'] = $m['set']['__repr__'];
	$m['frozenset'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '1f546e91fedd1ba63c24452a2d455e06';
		$method = $pyjs__bind_method2('__init__', function(_data) {
			if (this['__is_instance__'] === true) {
				var self = this;
				if ($pyjs['options']['arg_count'] && (arguments['length'] < 0 || arguments['length'] > 1)) $pyjs__exception_func_param(arguments['callee']['__name__'], 1, 2, arguments['length']+1);
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '1f546e91fedd1ba63c24452a2d455e06') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['frozenset']['toString'] = $m['frozenset']['__repr__'];
	$m['property'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'e3c14c469d639bf24505196dc04f7396';
		$method = $pyjs__bind_method2('__init__', function(fget, fset, fdel, doc) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== 'e3c14c469d639bf24505196dc04f7396') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['str'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'da66c5207e610789b6fd0d76492f0a98';
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['complex'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '16c04544c85ee6de901a4fc04ba8d9d9';
		$method = $pyjs__bind_method2('__init__', function(real, imag) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '16c04544c85ee6de901a4fc04ba8d9d9') {
...
r = Math['round'](n*x)/n;
	...
	$m['StringBuilder'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '9d7291539452f2ad216e4df8169bd903';
		$method = $pyjs__bind_method2('__init__', function() {
			if (this['__is_instance__'] === true) {
				var self = this;
				if ($pyjs['options']['arg_count'] && arguments['length'] != 0) $pyjs__exception_func_param(arguments['callee']['__name__'], 1, 1, arguments['length']+1);
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '9d7291539452f2ad216e4df8169bd903') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['TemplateFormatter'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '130198289f791cb2d563a81720fbe32a';
		...
		$method = $pyjs__bind_method2('__init__', function(space, template) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '130198289f791cb2d563a81720fbe32a') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['NumberSpec'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '7f4da381e602fd855d761a5ef8378705';
		var $bases = new Array($m['object']);
	...
	$m['BaseFormatter'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = 'a05d2c9a962168467a76cc46c656c923';
		$method = $pyjs__bind_method2('format_int_or_long', function(w_num, kind) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== 'a05d2c9a962168467a76cc46c656c923') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['Formatter'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '34a75cf83f80a320949856c83269f2e1';
		...
		$method = $pyjs__bind_method2('__init__', function(space, spec) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '34a75cf83f80a320949856c83269f2e1') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
	...
	$m['StringFormatSpace'] = (function(){
		...
		var $method;
		$cls_definition['__module__'] = 'pyjslib';
		$cls_definition['__md5__'] = '078af7a28059d1ef406db1cf071ad789';
		$method = $pyjs__bind_method2('format', function(w_obj, spec) {
			...
			if ($pyjs['options']['arg_instance_type']) {
				if (self.prototype['__md5__'] !== '078af7a28059d1ef406db1cf071ad789') {
					if (!$m['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
