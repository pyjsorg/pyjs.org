...
$pyjs.loaded_modules['pyjamas.Canvas2D'] = function (__mod_name__) {
	...
	try {
		...
		$m['Canvas'] = (function(){
			...
			$cls_definition.__md5__ = '60745506ecbdcfee297a88c479192daf';
			$method = $pyjs__bind_method2('__init__', function(Width, Height) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '60745506ecbdcfee297a88c479192daf') {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('init', function() {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('context', ctx) : $p['setattr'](self, 'context', ctx); 
				return null;
			}
	, 1, [null,null,['self']]);
