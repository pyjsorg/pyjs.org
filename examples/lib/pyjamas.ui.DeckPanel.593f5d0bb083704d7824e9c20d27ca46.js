...
$pyjs['loaded_modules']['pyjamas.ui.DeckPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('insert', function(widget, beforeIndex) {
				...
				if ((($bool3=((($bool2=$or1=((($cmp1=beforeIndex)===($cmp2=$constant_int_0)?0:
	...
	, 1, [null,null,['self'],['widget'],['beforeIndex', null]]);
			...
			$method = $pyjs__bind_method2('remove', function(widget) {
				...
				if ((($bool7=$p['op_eq']($p['getattr'](self, 'visibleWidget'), widget)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
						false :
						(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['widget']]);
			...
			$method = $pyjs__bind_method2('showWidget', function(index) {
				...
				if ((($bool8=!$p['op_is']($p['getattr'](self, 'visibleWidget'), null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
						false :
						(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['index']]);
			...
			$method = $pyjs__bind_method2('checkIndex', function(index) {
				...
				if ((($bool10=((($bool9=$or3=((($cmp5=index)===($cmp6=$constant_int_0)?0:
