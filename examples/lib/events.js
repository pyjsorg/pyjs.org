...
$pyjs.loaded_modules['events'] = function (__mod_name__) {
	...
	try {
		...
		$m['Events'] = (function(){
			...
			$cls_definition.__md5__ = '66afe002dd01f9f7453bb8dd7df8a8d1';
			$method = $pyjs__bind_method2('__init__', function(width, height) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '66afe002dd01f9f7453bb8dd7df8a8d1') {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('desc', $p['list']([])) : $p['setattr'](self, 'desc', $p['list']([])); 
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('status', $m['Label']('Execute any events on the canvas!')) : $p['setattr'](self, 'status', $m['Label']('Execute any events on the canvas!')); 
	...
	, 1, [null,null,['self'],['status']]);
			...
			$method = $pyjs__bind_method2('draw', function() {
				...
				circle1 = self['canvas']['circle']($constant_int_50, $constant_int_50, $constant_int_25);
				...
				circle2 = self['canvas']['circle']($constant_int_100, $constant_int_100, $constant_int_25);
				...
				rect1 = self['canvas']['rect']($constant_int_200, $constant_int_100, $constant_int_30, $constant_int_30);
				...
				rect2 = self['canvas']['rect']($constant_int_200, $constant_int_150, $constant_int_30, $constant_int_30);
				...
				ellipse = self['canvas']['ellipse']($constant_int_200, $constant_int_200, $constant_int_25, $constant_int_40);
				text = self['canvas']['text']($constant_int_200, $constant_int_200, 'ABC');
				set = self['canvas']['set']();
				set['add'](ellipse);
				set['add'](text);
