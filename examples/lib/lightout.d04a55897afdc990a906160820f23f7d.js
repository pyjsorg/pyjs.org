...
$pyjs['loaded_modules']['lightout'] = function (__mod_name__) {
	...
	try {
		...
		$m['GridCell'] = (function(){
			...
			$cls_definition['__md5__'] = 'a68f5b55c8fc3e89947eec84e880671b';
			$method = $pyjs__bind_method2('__init__', function(i, j) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'a68f5b55c8fc3e89947eec84e880671b') {
				...
				var element;
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('i', i) : $p['setattr'](self, 'i', i); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('j', j) : $p['setattr'](self, 'j', j); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('light', true) : $p['setattr'](self, 'light', true); 
						...
						(typeof $bool2=='object'?
							(typeof $bool2['__nonzero__']=='function'?
								...
								(typeof $bool2['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('light', false) : $p['setattr'](self, 'light', false); 
				}
				else {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('light', true) : $p['setattr'](self, 'light', true); 
				}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onClick', function(sender) {
				...
				if ((($bool3=((($cmp1=$p['getattr'](self, 'i'))===($cmp2=$constant_int_0)?0:
						...
						(typeof $bool3=='object'?
							(typeof $bool3['__nonzero__']=='function'?
								...
								(typeof $bool3['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['parent']['getWidget']((typeof ($sub1=$p['getattr'](self, 'i'))==typeof ($sub2=$constant_int_1) && (typeof $sub1=='number'||typeof $sub1=='string')?
						$sub1-$sub2:
						$p['op_sub']($sub1,$sub2)), $p['getattr'](self, 'j'))['toggle']();
				}
				if ((($bool4=((($cmp3=$p['getattr'](self, 'i'))===($cmp4=(typeof ($sub3=self['parent']['getRowCount']())==typeof ($sub4=$constant_int_1) && (typeof $sub3=='number'||typeof $sub3=='string')?
					$sub3-$sub4:
						...
						(typeof $bool4=='object'?
							(typeof $bool4['__nonzero__']=='function'?
								...
								(typeof $bool4['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['parent']['getWidget']((typeof ($add1=$p['getattr'](self, 'i'))==typeof ($add2=$constant_int_1) && (typeof $add1=='number'||typeof $add1=='string')?
						$add1+$add2:
						$p['op_add']($add1,$add2)), $p['getattr'](self, 'j'))['toggle']();
				}
				if ((($bool5=((($cmp5=$p['getattr'](self, 'j'))===($cmp6=$constant_int_0)?0:
						...
						(typeof $bool5=='object'?
							(typeof $bool5['__nonzero__']=='function'?
								...
								(typeof $bool5['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['parent']['getWidget']($p['getattr'](self, 'i'), (typeof ($sub5=$p['getattr'](self, 'j'))==typeof ($sub6=$constant_int_1) && (typeof $sub5=='number'||typeof $sub5=='string')?
						$sub5-$sub6:
						$p['op_sub']($sub5,$sub6)))['toggle']();
				}
				if ((($bool6=((($cmp7=$p['getattr'](self, 'j'))===($cmp8=(typeof ($sub7=self['parent']['getColumnCount']())==typeof ($sub8=$constant_int_1) && (typeof $sub7=='number'||typeof $sub7=='string')?
					$sub7-$sub8:
						...
						(typeof $bool6=='object'?
							(typeof $bool6['__nonzero__']=='function'?
								...
								(typeof $bool6['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['parent']['getWidget']($p['getattr'](self, 'i'), (typeof ($add3=$p['getattr'](self, 'j'))==typeof ($add4=$constant_int_1) && (typeof $add3=='number'||typeof $add3=='string')?
						$add3+$add4:
	...
	, 1, [null,null,['self']]);
		...
		$m['Game'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'lightout';
			$cls_definition['__md5__'] = 'ee85c8ae3f1d4a077338e266f264284a';
			$method = $pyjs__bind_method2('__init__', function(level) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'ee85c8ae3f1d4a077338e266f264284a') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['level']]);
			...
			$method = $pyjs__bind_method2('start_game', function(level) {
				...
				if ((($bool8=!$p['op_is'](level, null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
						false :
						(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['level', null]]);
			...
			$method = $pyjs__bind_method2('next_level', function() {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('level', (typeof ($add5=$p['getattr'](self, 'level'))==typeof ($add6=$constant_int_1) && (typeof $add5=='number'||typeof $add5=='string')?
					$add5+$add6:
					$p['op_add']($add5,$add6))) : $p['setattr'](self, 'level', (typeof ($add5=$p['getattr'](self, 'level'))==typeof ($add6=$constant_int_1) && (typeof $add5=='number'||typeof $add5=='string')?
					$add5+$add6:
					$p['op_add']($add5,$add6))); 
				self['start_game']();
				return null;
