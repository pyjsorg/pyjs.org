...
$pyjs['loaded_modules']['pyjamas.ui.Calendar'] = function (__mod_name__) {
	...
	try {
		...
		$m['Calendar'] = (function(){
			...
			$cls_definition['__md5__'] = 'af622e9f2e36b17c5b8909f75edb5052';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'af622e9f2e36b17c5b8909f75edb5052') {
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('isLeapYear', function(year) {
				...
				var $mod5,$or1,$bool3,$or2,$mod6,$and1,$bool2,$mod4,$bool1,$mod1,$mod3,$mod2,$and2;
				if ((($bool3=((($bool2=$or1=((($bool1=$and1=$p['op_eq']((typeof ($mod1=year)==typeof ($mod2=$constant_int_4) && typeof $mod1=='number'?
					(($mod1=$mod1%$mod2)<0&&$mod2>0?$mod1+$mod2:$mod1):
					$p['op_mod']($mod1,$mod2)), $constant_int_0)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
					...
					$p['op_mod']($mod3,$mod4)), $constant_int_0):$and1)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
					false :
					(typeof $bool2=='object'?
					...
					$p['op_mod']($mod5,$mod6)), $constant_int_0))) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
	...
	, 1, [null,null,['self'],['year']]);
			...
			$method = $pyjs__bind_method2('getDaysInMonth', function(mth, year) {
				...
				var $and3,$and4,days,$bool6,$bool7,$bool4,$bool5;
				days = $constant_int_0;
				if ((($bool4=$p['list']([$constant_int_1, $constant_int_3, $constant_int_5, $constant_int_7, $constant_int_8, $constant_int_10, $constant_int_12])['__contains__'](mth)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
				...
				else if ((($bool5=$p['list']([$constant_int_4, $constant_int_6, $constant_int_9, $constant_int_11])['__contains__'](mth)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
				...
				else if ((($bool7=((($bool6=$and3=$p['op_eq'](mth, $constant_int_2)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
					false :
					(typeof $bool6=='object'?
	...
	, 1, [null,null,['self'],['left'],['top']]);
			...
			$method = $pyjs__bind_method2('show', function(left, top) {
				...
				if ((($bool8=((($cmp1=left)===($cmp2=$constant_int_0)?0:
				...
				if ((($bool9=((($cmp3=top)===($cmp4=$constant_int_0)?0:
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('draw', function(month, year) {
				...
				var $bool10,$bool11,$bool12,$bool13,$bool14,$bool15,$bool16,hasChangeMonth,txt,$sub2,$sub1,tod,$or4,$or3,$and5,$and6,$and7,yy,$bool17,$2,$1,g,mm,$add2,$add3,$add1,$add6,$add7,$add4,$add5,$add8;
				tod = $m['time']['localtime']();
				mm = $p['getattr'](tod, 'tm_mon');
				yy = $p['getattr'](tod, 'tm_year');
				hasChangeMonth = false;
				if ((($bool11=((($bool10=$or3=!$p['op_eq'](yy, $p['getattr'](self, 'todayYear'))) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
					false :
						...
						(typeof $bool10['__nonzero__']=='function'?
							...
							(typeof $bool10['__len__']=='function'?
								($bool10['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or3:!$p['op_eq'](mm, $p['getattr'](self, 'todayMonth')))) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
				...
				if ((($bool12=$p['op_is']($p['getattr'](self, 'defaultGrid'), null)) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
						false :
							...
							(typeof $bool14['__nonzero__']=='function'?
								...
								(typeof $bool14['__len__']=='function'?
									($bool14['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool15=$and6=$p['op_eq'](month, $p['getattr'](self, 'todayMonth'))) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
						false :
							...
							(typeof $bool15['__nonzero__']=='function'?
								...
								(typeof $bool15['__len__']=='function'?
									($bool15['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$p['op_eq'](year, $p['getattr'](self, 'todayYear')):$and6):$and5)) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
							false :
	...
	, 1, [null,null,['self'],['month'],['year']]);
			...
			$method = $pyjs__bind_method2('drawGrid', function(month, year) {
				...
				var $bool18,$bool19,$add36,pos,$add35,$6,$mod7,daysInMonth,slots,$add26,$mod9,startPos,row,$add29,$add28,rows,struct,$add21,$add20,$add22,$add25,$add24,$add27,$mod8,$bool25,$bool24,$bool21,$iter1_array,$bool23,$bool22,$sub6,$sub5,$bool20,$and8,$and9,$iter1_nextval,$mod10,$mod12,$5,$mod11,$and12,day,$and10,$add17,grid,$cmp10,$div2,$div1,$add18,$add19,$cmp5,$cmp7,$cmp6,$iter1_type,$iter1_iter,$add33,$add30,$add31,$cmp9,$cmp8,$add34,col,i,secs,$and11,$iter1_idx,$add32,$add23;
				...
				while ((($bool19=((($cmp7=day)===($cmp8=daysInMonth)?0:
						...
						(typeof $bool19=='object'?
							(typeof $bool19['__nonzero__']=='function'?
								...
								(typeof $bool19['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool21=((($bool20=$and8=$p['op_eq']((typeof ($mod9=pos)==typeof ($mod10=$constant_int_7) && typeof $mod9=='number'?
						(($mod9=$mod9%$mod10)<0&&$mod10>0?$mod9+$mod10:$mod9):
						$p['op_mod']($mod9,$mod10)), $constant_int_0)) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
						false :
							...
							(typeof $bool20['__nonzero__']=='function'?
								...
								(typeof $bool20['__len__']=='function'?
									($bool20['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?!$p['op_eq'](day, $constant_int_1):$and8)) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
							false :
					...
					if ((($bool24=((($bool22=$and10=$p['op_eq']($p['getattr'](self, 'currentYear'), $p['getattr'](self, 'todayYear'))) === null || $bool22 === false || $bool22 === 0 || $bool22 === '' ?
						false :
							...
							(typeof $bool22['__nonzero__']=='function'?
								...
								(typeof $bool22['__len__']=='function'?
									($bool22['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?((($bool23=$and11=$p['op_eq']($p['getattr'](self, 'currentMonth'), $p['getattr'](self, 'todayMonth'))) === null || $bool23 === false || $bool23 === 0 || $bool23 === '' ?
						false :
							...
							(typeof $bool23['__nonzero__']=='function'?
								...
								(typeof $bool23['__len__']=='function'?
									($bool23['__len__']()>0 ?
										...
										false) :
									true ) ) :
							 true ) )?$p['op_eq'](day, $p['getattr'](self, 'todayDay')):$and11):$and10)) === null || $bool24 === false || $bool24 === 0 || $bool24 === '' ?
							false :
				...
				while ((($bool25=((($cmp9=col)===($cmp10=$constant_int_7)?0:
	...
	, 1, [null,null,['self'],['month'],['year']]);
			...
			$method = $pyjs__bind_method2('onCellClicked', function(grid, row, col) {
				...
				var selectedDay,$iter2_nextval,e,$iter2_iter,text,$iter2_idx,$pyjs_try_err,$bool28,listener,$bool27,$bool26,$iter2_type,$iter2_array;
				if ((($bool26=$p['op_eq'](row, $constant_int_0)) === null || $bool26 === false || $bool26 === 0 || $bool26 === '' ?
						false :
				...
				if ((($bool27=$p['op_eq'](text, '')) === null || $bool27 === false || $bool27 === 0 || $bool27 === '' ?
						false :
	...
	, 1, [null,null,['self'],['month'],['year']]);
			...
			$method = $pyjs__bind_method2('drawPreviousMonth', function() {
				...
				var $sub12,$sub11,$sub10,$sub9,$bool30;
				if ((($bool30=$p['op_eq']($p['int']($p['getattr'](self, 'currentMonth')), $constant_int_1)) === null || $bool30 === false || $bool30 === 0 || $bool30 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('drawNextMonth', function() {
				...
				var $add39,$add42,$add41,$add40,$bool31;
				if ((($bool31=$p['op_eq']($p['int']($p['getattr'](self, 'currentMonth')), $constant_int_12)) === null || $bool31 === false || $bool31 === 0 || $bool31 === '' ?
						false :
	...
	, 1, [null,null,['self']]);
		...
		$m['DateField'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.ui.Calendar';
			$cls_definition['__md5__'] = '700fda6471da3f779be4cad303bfc99a';
			...
			$method = $pyjs__bind_method2('__init__', function(format) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '700fda6471da3f779be4cad303bfc99a') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				if ((($bool32=((((($cmp11=format['find']('-'))===($cmp12=$constant_int_0)?0:
				...
				else if ((($bool33=((((($cmp13=format['find']('/'))===($cmp14=$constant_int_0)?0:
				...
				else if ((($bool34=((((($cmp15=format['find']('.'))===($cmp16=$constant_int_0)?0:
	...
	, 1, [null,null,['self'],['yyyy'],['mm'],['dd']]);
			...
			$method = $pyjs__bind_method2('onLostFocus', function(sender) {
				...
				var $add50,$add51,$add46,$add49,$add48,$add47,text,$len1,$add52,$and13,$bool36,$and14,$bool35,txt,$add45;
					...
					(typeof $len1['__array'] != 'undefined' ? new $p['int']($len1['__array']['length']):
						(typeof $len1['__len__'] == 'function'?$len1['__len__']():
							(typeof $len1['length'] != 'undefined'? new $p['int']($len1['length']):
								$p['len']($len1))))), $constant_int_8):$and13)) === null || $bool36 === false || $bool36 === 0 || $bool36 === '' ?
						false :
						(typeof $bool36=='object'?
							(typeof $bool36['__nonzero__']=='function'?
								...
								(typeof $bool36['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					txt = (typeof ($add51=(typeof ($add49=(typeof ($add47=(typeof ($add45=$p['__getslice'](text, $constant_int_0, $constant_int_2))==typeof ($add46=$p['getattr'](self, 'sep')) && (typeof $add45=='number'||typeof $add45=='string')?
						$add45+$add46:
						$p['op_add']($add45,$add46)))==typeof ($add48=$p['__getslice'](text, $constant_int_2, $constant_int_4)) && (typeof $add47=='number'||typeof $add47=='string')?
						$add47+$add48:
						$p['op_add']($add47,$add48)))==typeof ($add50=$p['getattr'](self, 'sep')) && (typeof $add49=='number'||typeof $add49=='string')?
						$add49+$add50:
						$p['op_add']($add49,$add50)))==typeof ($add52=$p['__getslice'](text, $constant_int_4, $constant_int_8)) && (typeof $add51=='number'||typeof $add51=='string')?
						$add51+$add52:
	...
	, 1, [null,null,['self'],['event']]);
			...
			$method = $pyjs__bind_method2('onShowCalendar', function(sender) {
				...
				x = (typeof ($add53=self['tbox']['getAbsoluteLeft']())==typeof ($add54=$constant_int_10) && (typeof $add53=='number'||typeof $add53=='string')?
					$add53+$add54:
					$p['op_add']($add53,$add54));
				y = (typeof ($add55=self['tbox']['getAbsoluteTop']())==typeof ($add56=$constant_int_10) && (typeof $add55=='number'||typeof $add55=='string')?
					$add55+$add56:
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$m['CalendarPopup'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.ui.Calendar';
			$cls_definition['__md5__'] = 'e1a3b32ec4176fbf196a4516d51f7226';
			$method = $pyjs__bind_method2('__init__', function(c) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'e1a3b32ec4176fbf196a4516d51f7226') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
