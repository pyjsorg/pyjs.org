...
$pyjs['loaded_modules']['ClickableRootPanel'] = function (__mod_name__) {
	...
	try {
		...
		$m['RootPanelListener'] = (function(){
			...
			$cls_definition['__md5__'] = 'e2597a04d1b5947afaf2ea29a372f9a8';
			$method = $pyjs__bind_method2('__init__', function(Parent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'e2597a04d1b5947afaf2ea29a372f9a8') {
	...
	, 1, ['args',['kwargs'],['self'],['Parent']]);
			...
			$method = $pyjs__bind_method2('onClick', function(Sender) {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('focussed', !(($bool1=$p['getattr'](self, 'focussed')) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
						(typeof $bool1['__nonzero__']=='function'?
							...
							(typeof $bool1['__len__']=='function'?
								($bool1['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )) : $p['setattr'](self, 'focussed', !(($bool1=$p['getattr'](self, 'focussed')) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
						(typeof $bool1['__nonzero__']=='function'?
							$bool1['__nonzero__']() :
