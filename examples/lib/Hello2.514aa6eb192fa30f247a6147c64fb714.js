/* start module: Hello2 */
$pyjs['loaded_modules']['Hello2'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['Hello2']['__was_initialized__']) return $pyjs['loaded_modules']['Hello2'];
	var $m = $pyjs['loaded_modules']['Hello2'];
	$m['__repr__'] = function() { return '<module: Hello2>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'Hello2';
