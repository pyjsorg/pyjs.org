...
$pyjs['loaded_modules']['pyjamas.ui.CellPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getCellHorizontalAlignment', function(widget) {
				...
				if ((($bool3=$p['op_is'](td, null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
	...
	, 1, [null,null,['self'],['widget']]);
			...
			$method = $pyjs__bind_method2('getCellVerticalAlignment', function(widget) {
				...
				var td,$bool4;
				td = self['getWidgetTd'](widget);
				if ((($bool4=$p['op_is'](td, null)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
	...
	, 1, [null,null,['self'],['widget']]);
			...
			$method = $pyjs__bind_method2('setBorderWidth', function(width) {
				...
				var $or4,$or3,$bool6,$bool7;
				if ((($bool7=((($bool6=$or3=$p['op_is'](width, null)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
					false :
					(typeof $bool6=='object'?
						(typeof $bool6['__nonzero__']=='function'?
							...
							(typeof $bool6['__len__']=='function'?
								($bool6['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or3:$p['op_eq'](width, ''))) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
						false :
						(typeof $bool7=='object'?
	...
	, 1, [null,null,['self'],['width']]);
			...
			$method = $pyjs__bind_method2('setCellHeight', function(widget, height) {
				...
				var td,$bool8;
				td = $m['DOM']['getParent'](widget['getElement']());
				if ((($bool8=$p['op_is'](height, null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
						false :
						(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['widget'],['height']]);
			...
			$method = $pyjs__bind_method2('setCellHorizontalAlignment', function(widget, align) {
				...
				var $bool10,td,$bool9;
				td = self['getWidgetTd'](widget);
				if ((($bool9=!$p['op_is'](td, null)) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
						false :
						(typeof $bool9=='object'?
							(typeof $bool9['__nonzero__']=='function'?
								...
								(typeof $bool9['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool10=$p['op_is'](align, null)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
							false :
	...
	, 1, [null,null,['self'],['widget'],['align']]);
			...
			$method = $pyjs__bind_method2('setCellVerticalAlignment', function(widget, align) {
				...
				td = self['getWidgetTd'](widget);
				if ((($bool11=!$p['op_is'](td, null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
						(typeof $bool11=='object'?
							(typeof $bool11['__nonzero__']=='function'?
								...
								(typeof $bool11['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool12=$p['op_is'](align, null)) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
							false :
	...
	, 1, [null,null,['self'],['widget'],['align']]);
			...
			$method = $pyjs__bind_method2('setCellWidth', function(widget, width) {
				...
				var $bool13,td;
				td = $m['DOM']['getParent'](widget['getElement']());
				if ((($bool13=$p['op_is'](width, null)) === null || $bool13 === false || $bool13 === 0 || $bool13 === '' ?
						false :
	...
	, 1, [null,null,['self'],['widget'],['width']]);
			...
			$method = $pyjs__bind_method2('setSpacing', function(spacing) {
				...
				if ((($bool14=$p['op_is'](spacing, null)) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
						false :
	...
	, 1, [null,null,['self'],['spacing']]);
			...
			$method = $pyjs__bind_method2('setPadding', function(padding) {
				...
				if ((($bool15=$p['op_is'](padding, null)) === null || $bool15 === false || $bool15 === 0 || $bool15 === '' ?
						false :
