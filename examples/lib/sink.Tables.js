/* start module: sink.Tables */
$pyjs['loaded_modules']['sink.Tables'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['sink.Tables']['__was_initialized__']) return $pyjs['loaded_modules']['sink.Tables'];
	if(typeof $pyjs['loaded_modules']['sink'] == 'undefined' || !$pyjs['loaded_modules']['sink']['__was_initialized__']) $p['___import___']('sink', null);
	var $m = $pyjs['loaded_modules']['sink.Tables'];
	$m['__repr__'] = function() { return '<module: sink.Tables>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'sink.Tables';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['sink']['Tables'] = $pyjs['loaded_modules']['sink.Tables'];
	try {
		...
		$m['FlexTable'] = $p['___import___']('pyjamas.ui.FlexTable.FlexTable', 'sink', null, false);
		$m['HasHorizontalAlignment'] = $p['___import___']('pyjamas.ui.HasHorizontalAlignment', 'sink', null, false);
		$m['Image'] = $p['___import___']('pyjamas.ui.Image.Image', 'sink', null, false);
		$m['Tables'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'sink.Tables';
			$cls_definition['__md5__'] = '157be147dbd2c9482f4e6fa54a5a1a25';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '157be147dbd2c9482f4e6fa54a5a1a25') {
