...
$pyjs['loaded_modules']['pyjamas.ui.HorizontalSplitPanel'] = function (__mod_name__) {
	...
	try {
		...
		$m['HorizontalSplitPanel'] = (function(){
			...
			$cls_definition['__md5__'] = '89d74d6bd20902fe8c39d372b0e75180';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '89d74d6bd20902fe8c39d372b0e75180') {
	...
	, 1, [null,['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('setLeftWidget', function(leftWidget) {
				...
				self['setWidget']($constant_int_0, leftWidget);
				return null;
			}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('setRightWidget', function(rightWidget) {
				...
				self['setWidget']($constant_int_1, rightWidget);
				return null;
			}
