...
$pyjs['loaded_modules']['ClassTest'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$m['ClassTest'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'ClassTest';
			$cls_definition['__md5__'] = 'a1dbeee92a63bf2ea4c0c2bed49c9fd8';
			$method = $pyjs__bind_method2('testInstancePassing', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'a1dbeee92a63bf2ea4c0c2bed49c9fd8') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('testMultiDoubleInherit', function() {
				...
				self['assertEqual']($p['str'](i), 'MultiInherit2', 'Inheritance problem issue #560');
