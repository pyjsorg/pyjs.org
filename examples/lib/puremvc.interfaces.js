...
$pyjs.loaded_modules['puremvc.interfaces'] = function (__mod_name__) {
	...
	try {
		...
		$m['ICommand'] = (function(){
			...
			$cls_definition.__md5__ = 'fae5c52c5c35264c97a2f50742dd6410';
			$method = $pyjs__bind_method2('execute', function(notification) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'fae5c52c5c35264c97a2f50742dd6410') {
	...
	, 1, [null,null,['self'],['notification']]);
		...
		$m['IController'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = 'f1b066de55b651a940b9ce18925b1959';
			$method = $pyjs__bind_method2('registerCommand', function(notificationName, commandClassRef) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'f1b066de55b651a940b9ce18925b1959') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['notificationName']]);
		...
		$m['IFacade'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = '4f7175a24b4487a96ba9b94b9a82d540';
			$method = $pyjs__bind_method2('notifyObservers', function(note) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '4f7175a24b4487a96ba9b94b9a82d540') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['mediatorName']]);
		...
		$m['IMediator'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = 'fbf8d78e1cd6d6317f70c4957ec3e134';
			$method = $pyjs__bind_method2('getMediatorName', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'fbf8d78e1cd6d6317f70c4957ec3e134') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
		...
		$m['IModel'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = 'dd66a05362c9ff8a8480ea7cff9285d1';
			$method = $pyjs__bind_method2('registerProxy', function(proxy) {
				if (this.__is_instance__ === true) {
					var self = this;
					if ($pyjs.options.arg_count && arguments.length != 1) $pyjs__exception_func_param(arguments.callee.__name__, 2, 2, arguments.length+1);
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'dd66a05362c9ff8a8480ea7cff9285d1') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['proxyName']]);
		...
		$m['INotification'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = '1e970c7b1f4dbac336dbeb3f82629897';
			$method = $pyjs__bind_method2('getName', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '1e970c7b1f4dbac336dbeb3f82629897') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
		...
		$m['INotifier'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = '18fff4eac85ecea1dc7c6048108aa53c';
			$method = $pyjs__bind_method2('sendNotification', function(notificationName, body, type) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '18fff4eac85ecea1dc7c6048108aa53c') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['notificationName'],['body', null],['type', null]]);
		...
		$m['IObserver'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = '7a91a47316b56fc12552feea976b3ec0';
			$method = $pyjs__bind_method2('setNotifyMethod', function(notifyMethod) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '7a91a47316b56fc12552feea976b3ec0') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['object']]);
		...
		$m['IProxy'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = 'bf33f0b96779c0ef18b70ddb09d8e222';
			$method = $pyjs__bind_method2('getProxyName', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'bf33f0b96779c0ef18b70ddb09d8e222') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
		...
		$m['IView'] = (function(){
			...
			var $method;
			$cls_definition.__module__ = 'puremvc.interfaces';
			$cls_definition.__md5__ = 'd08edbbe5584dbd68307b7e523996b4b';
			$method = $pyjs__bind_method2('registerObserver', function(notificationName, observer) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'd08edbbe5584dbd68307b7e523996b4b') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
