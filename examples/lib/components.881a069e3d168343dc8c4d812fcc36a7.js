...
$pyjs['loaded_modules']['components'] = function (__mod_name__) {
	...
	try {
		...
		$m['PyJsApp'] = (function(){
			...
			$cls_definition['__md5__'] = '0c5fae0648ad07aa53baec67435d46c5';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0c5fae0648ad07aa53baec67435d46c5') {
	...
	, 1, [null,null,['self']]);
		...
		$m['AppFrame'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'components';
			$cls_definition['__md5__'] = 'cf1b77fa19180a1d61c8e992ca7663f2';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'cf1b77fa19180a1d61c8e992ca7663f2') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
		...
		$m['RolePanel'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'components';
			$cls_definition['__md5__'] = '461917939cf35c3dc1a28809213e7692';
			...
			$method = $pyjs__bind_method2('__init__', function(parent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '461917939cf35c3dc1a28809213e7692') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['sender'],['keyCode'],['modifiers']]);
		...
		$m['UserList'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'components';
			$cls_definition['__md5__'] = 'f5398ce0c8ef3f94d685daa3f36e506d';
			...
			$method = $pyjs__bind_method2('__init__', function(parent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'f5398ce0c8ef3f94d685daa3f36e506d') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
		...
		$m['UserForm'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'components';
			$cls_definition['__md5__'] = '892d6081a942874f88b21c7f651144f2';
			...
			$method = $pyjs__bind_method2('__init__', function(parent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '892d6081a942874f88b21c7f651144f2') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
