...
(function(){
	...
	$m['tuple'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = '95a2a534e10d928514b0709696928f03';
		$method = $pyjs__bind_method2('__init__', function(data) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '95a2a534e10d928514b0709696928f03') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$enumerate_array.prototype.$genfunc = $enumerate_array.prototype.next;
	...
	$m['list'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = '115577229af0dbf29e11c4e933d1ba2a';
		$method = $pyjs__bind_method2('__init__', function(data) {
			if (this.__is_instance__ === true) {
				var self = this;
				if ($pyjs.options.arg_count && (arguments.length < 0 || arguments.length > 1)) $pyjs__exception_func_param(arguments.callee.__name__, 1, 2, arguments.length+1);
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '115577229af0dbf29e11c4e933d1ba2a') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['slice'].toString = $m['slice'].__str__;
	$m['dict'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = '3fb27fe27cebbf22ed00230df7ccd20c';
		$method = $pyjs__bind_method2('__init__', function(seq) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '3fb27fe27cebbf22ed00230df7ccd20c') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['dict'].__str__ = $m['dict'].__repr__;
	...
	$m['set'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = '1bdc344f17d8d8f6404456fea8491acf';
		$method = $pyjs__bind_method2('__init__', function(_data) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '1bdc344f17d8d8f6404456fea8491acf') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['set']['toString'] = $m['set']['__repr__'];
	$m['frozenset'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = 'ca1eafe54fe9ad73bcf897ff9ace68b5';
		$method = $pyjs__bind_method2('__init__', function(_data) {
			if (this.__is_instance__ === true) {
				var self = this;
				if ($pyjs.options.arg_count && (arguments.length < 0 || arguments.length > 1)) $pyjs__exception_func_param(arguments.callee.__name__, 1, 2, arguments.length+1);
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== 'ca1eafe54fe9ad73bcf897ff9ace68b5') {
					if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
						$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
					}
				}
...
$m['frozenset']['toString'] = $m['frozenset']['__repr__'];
	...
	$m['str'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = '9e85c0832fa382804157133de2f2449f';
...
var $generator_state = [0], $generator_exc = [null], $yield_value = null, $exc = null, $is_executing=false;
	...
	$m['complex'] = (function(){
		...
		var $method;
		$cls_definition.__module__ = 'pyjslib';
		$cls_definition.__md5__ = '2cc81396c2bf4925fd1afa7c95fa2eaf';
		$method = $pyjs__bind_method2('__init__', function(real, imag) {
			...
			if ($pyjs.options.arg_instance_type) {
				if (self.prototype.__md5__ !== '2cc81396c2bf4925fd1afa7c95fa2eaf') {
