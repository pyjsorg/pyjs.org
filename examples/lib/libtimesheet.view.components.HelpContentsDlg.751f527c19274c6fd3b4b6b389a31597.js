/* start module: libtimesheet.view.components.HelpContentsDlg */
$pyjs['loaded_modules']['libtimesheet.view.components.HelpContentsDlg'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.components.HelpContentsDlg']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.components.HelpContentsDlg'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.components.HelpContentsDlg'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.components.HelpContentsDlg>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.components.HelpContentsDlg';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view.components']['HelpContentsDlg'] = $pyjs['loaded_modules']['libtimesheet.view.components.HelpContentsDlg'];
	try {
		...
		$m['HelpContentsDlg'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.components.HelpContentsDlg';
			$cls_definition['__md5__'] = 'b90e17a6d3bfe07aadf65e522fb064bd';
			$method = $pyjs__bind_method2('__init__', function(left, top) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'b90e17a6d3bfe07aadf65e522fb064bd') {
	...
	return this;
}; /* end libtimesheet.view.components.HelpContentsDlg */


/* end module: libtimesheet.view.components.HelpContentsDlg */
