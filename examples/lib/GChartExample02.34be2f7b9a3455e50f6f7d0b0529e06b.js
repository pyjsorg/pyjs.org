...
$pyjs['loaded_modules']['GChartExample02'] = function (__mod_name__) {
	...
	try {
		...
		$m['MAX_REVENUE'] = $constant_int_1000;
		$m['WIDTH'] = 500.0;
		$m['HEIGHT'] = 400.0;
		$m['GChartExample02'] = (function(){
			...
			$cls_definition['__md5__'] = 'ec7a477cecccb099e28c79f440d03743';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'ec7a477cecccb099e28c79f440d03743') {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('updateButton', $m['Button']('<b><big>Generate New Simulated Revenues</big></b>')) : $p['setattr'](self, 'updateButton', $m['Button']('<b><big>Generate New Simulated Revenues</big></b>')); 
				...
				$iter1_iter = $p['range']((($len1=$m['barLabels']) === null?$constant_int_0:
				...
				while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
					...
					$iter2_iter = $p['range']((($len2=$m['groupLabels']) === null?$constant_int_0:
					...
					while (typeof ($iter2_nextval=($iter2_type?($iter2_type > 0?$iter2_iter.next(true,false):$p['wrapped_next']($iter2_iter)):$iter2_array[$iter2_idx++])) != 'undefined') {
						...
						y = (typeof ($mul1=$m['rnd']())==typeof ($mul2=$m['MAX_REVENUE']) && typeof $mul1=='number'?
							$mul1*$mul2:
							$p['op_mul']($mul1,$mul2));
						self['getCurve']()['addPoint']((typeof ($add11=(typeof ($add7=$constant_int_1)==typeof ($add8=iCurve) && (typeof $add7=='number'||typeof $add7=='string')?
							$add7+$add8:
							$p['op_add']($add7,$add8)))==typeof ($add12=(typeof ($mul3=jGroup)==typeof ($mul4=(typeof ($add9=(($len3=$m['barLabels']) === null?$constant_int_0:
							(typeof $len3['__array'] != 'undefined' ? new $p['int']($len3['__array']['length']):
								(typeof $len3['__len__'] == 'function'?$len3['__len__']():
									(typeof $len3['length'] != 'undefined'? new $p['int']($len3['length']):
										$p['len']($len3))))))==typeof ($add10=$constant_int_1) && (typeof $add9=='number'||typeof $add9=='string')?
							$add9+$add10:
				...
				$iter3_iter = $p['range']((($len4=$m['groupLabels']) === null?$constant_int_0:
				...
				while (typeof ($iter3_nextval=($iter3_type?($iter3_type > 0?$iter3_iter.next(true,false):$p['wrapped_next']($iter3_iter)):$iter3_array[$iter3_idx++])) != 'undefined') {
					i = $iter3_nextval;
					self['getXAxis']()['addTick']((typeof ($add15=(typeof ($div1=(($len5=$m['barLabels']) === null?$constant_int_0:
						...
						$div1/$div2:
						$p['op_div']($div1,$div2)))==typeof ($add16=(typeof ($mul5=i)==typeof ($mul6=(typeof ($add13=(($len6=$m['barLabels']) === null?$constant_int_0:
						(typeof $len6['__array'] != 'undefined' ? new $p['int']($len6['__array']['length']):
							(typeof $len6['__len__'] == 'function'?$len6['__len__']():
								(typeof $len6['length'] != 'undefined'? new $p['int']($len6['length']):
									$p['len']($len6))))))==typeof ($add14=$constant_int_1) && (typeof $add13=='number'||typeof $add13=='string')?
						$add13+$add14:
