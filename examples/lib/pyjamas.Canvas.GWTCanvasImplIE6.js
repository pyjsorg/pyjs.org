...
$pyjs.loaded_modules['pyjamas.Canvas.GWTCanvasImplIE6'] = function (__mod_name__) {
    ...
    if (!$doc.namespaces["v"]) {
		...
		$m['GWTCanvasImplIE6'] = (function(){
			...
			$cls_definition.__md5__ = '883eecb9c9ed9d7e3caf971d47ac1717';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '883eecb9c9ed9d7e3caf971d47ac1717') {
	...
	, 1, [null,null,['self'],['x'],['y'],['w'],['h']]);
			...
			$method = $pyjs__bind_method2('transform', function(m12, m21, m22, dx, dy) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (m11.prototype.__md5__ !== '883eecb9c9ed9d7e3caf971d47ac1717') {
						if (!$p['_isinstance'](m11, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], m11);
						}
					}
				}
				...
				$p['getattr']((typeof self == "undefined"?$m.self:self), 'matrix').__setitem__($constant_int_0, (typeof ($add89=(typeof ($mul61=a)==typeof ($mul62=m11) && typeof $mul61=='number'?
					$mul61*$mul62:
				...
				$p['getattr']((typeof self == "undefined"?$m.self:self), 'matrix').__setitem__($constant_int_1, (typeof ($add91=(typeof ($mul65=a)==typeof ($mul66=m12) && typeof $mul65=='number'?
					$mul65*$mul66:
				...
				$p['getattr']((typeof self == "undefined"?$m.self:self), 'matrix').__setitem__($constant_int_3, (typeof ($add97=(typeof ($mul73=a)==typeof ($mul74=m11) && typeof $mul73=='number'?
					$mul73*$mul74:
				...
				$p['getattr']((typeof self == "undefined"?$m.self:self), 'matrix').__setitem__($constant_int_4, (typeof ($add99=(typeof ($mul77=a)==typeof ($mul78=m12) && typeof $mul77=='number'?
					$mul77*$mul78:
