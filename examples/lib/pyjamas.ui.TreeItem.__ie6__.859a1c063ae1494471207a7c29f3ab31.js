...
$pyjs['loaded_modules']['pyjamas.ui.TreeItem'] = function (__mod_name__) {
	...
	try {
		...
		$m['TreeItem'] = (function(){
			...
			$cls_definition['__md5__'] = 'e011af4d835657559d9b1ff8a1a9bd26';
			$method = $pyjs__bind_method2('__init__', function(html) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'e011af4d835657559d9b1ff8a1a9bd26') {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('createImage', function() {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('canvas', $m['GWTCanvas']($constant_int_16, $constant_int_16, $constant_int_16, $constant_int_16)) : $p['setattr'](self, 'canvas', $m['GWTCanvas']($constant_int_16, $constant_int_16, $constant_int_16, $constant_int_16)); 
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('drawImage', function(mode) {
				...
				var $bool45,$bool46,canvas;
				canvas = $p['getattr'](self, 'canvas');
				canvas['resize']($constant_int_16, $constant_int_16);
				canvas['saveContext']();
				...
				canvas['setLineWidth']($constant_int_1);
				canvas['setStrokeStyle']($m['Color']['Color']('#aaa'));
				canvas['strokeRect']($constant_int_4, $constant_int_4, $constant_int_8, $constant_int_8);
				canvas['setStrokeStyle']($m['Color']['Color']('#222'));
				canvas['setLineWidth']($constant_int_1);
				canvas['moveTo']($constant_int_5, $constant_int_8);
				canvas['lineTo']($constant_int_11, $constant_int_8);
				if ((($bool46=$p['op_eq'](mode, 'closed')) === null || $bool46 === false || $bool46 === 0 || $bool46 === '' ?
						false :
						(typeof $bool46=='object'?
							(typeof $bool46['__nonzero__']=='function'?
								...
								(typeof $bool46['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					canvas['moveTo']($constant_int_8, $constant_int_5);
					canvas['lineTo']($constant_int_8, $constant_int_11);
				}
				canvas['stroke']();
	...
	, 1, [null,null,['self'],['mode']]);
		...
		$m['RootTreeItem'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.ui.TreeItem';
			$cls_definition['__md5__'] = '30096291ffa9546bceabee268175e6b9';
			$method = $pyjs__bind_method2('addItem', function(item) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 2, 2, arguments['length']+1);
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '30096291ffa9546bceabee268175e6b9') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['item']]);
			...
			$method = $pyjs__bind_method2('insertItem', function(item, index) {
				...
				if (typeof index == 'undefined') index=arguments['callee']['__args__'][4][1];
				var $bool47,$or9,$bool49,$bool48,$or10;
				if ((($bool48=((($bool47=$or9=!$p['op_is'](item['getParentItem'](), null)) === null || $bool47 === false || $bool47 === 0 || $bool47 === '' ?
					false :
						...
						(typeof $bool47['__nonzero__']=='function'?
							...
							(typeof $bool47['__len__']=='function'?
								($bool47['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )?$or9:!$p['op_is'](item['getTree'](), null))) === null || $bool48 === false || $bool48 === 0 || $bool48 === '' ?
						false :
				...
				item['setParentItem'](null);
				if ((($bool49=$p['op_is'](index, null)) === null || $bool49 === false || $bool49 === 0 || $bool49 === '' ?
						false :
	...
	, 1, [null,null,['self'],['item'],['index', null]]);
			...
			$method = $pyjs__bind_method2('removeItem', function(item) {
				...
				var $bool50;
				if ((($bool50=!$p['getattr'](self, 'children')['__contains__'](item)) === null || $bool50 === false || $bool50 === 0 || $bool50 === '' ?
						false :
