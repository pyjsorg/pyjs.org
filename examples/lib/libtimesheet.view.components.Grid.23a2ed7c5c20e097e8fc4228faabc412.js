/* start module: libtimesheet.view.components.Grid */
$pyjs['loaded_modules']['libtimesheet.view.components.Grid'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.components.Grid']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.components.Grid'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.components.Grid'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.components.Grid>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.components.Grid';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view.components']['Grid'] = $pyjs['loaded_modules']['libtimesheet.view.components.Grid'];
	try {

		var $constant_int_0 = new $p['int'](0);
		var $constant_int_1 = new $p['int'](1);
		$m['pyjamas'] = $p['___import___']('pyjamas.ui.Grid', 'libtimesheet.view.components');
		$m['Grid'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.components.Grid';
			$cls_definition['__md5__'] = 'c251f3d3ca508a005be87eb7365548c2';
			$method = $pyjs__bind_method2('__init__', function(topHeader, leftBorder) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'c251f3d3ca508a005be87eb7365548c2') {
						...
						(typeof $bool1=='object'?
							(typeof $bool1['__nonzero__']=='function'?
								...
								(typeof $bool1['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('top', $constant_int_1) : $p['setattr'](self, 'top', $constant_int_1); 
				}
				else {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('top', $constant_int_0) : $p['setattr'](self, 'top', $constant_int_0); 
				}
						...
						(typeof $bool2=='object'?
							(typeof $bool2['__nonzero__']=='function'?
								...
								(typeof $bool2['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('left', $constant_int_1) : $p['setattr'](self, 'left', $constant_int_1); 
				}
				else {
					self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('left', $constant_int_0) : $p['setattr'](self, 'left', $constant_int_0); 
				}
				return null;
			}
	, 1, [null,null,['self'],['topHeader', true],['leftBorder', true]]);
			...
			$method = $pyjs__bind_method2('createGrid', function(rows, cols) {
				...
				self['getRowFormatter']()['addStyleName']($constant_int_0, 'gwt-BorderRow');
				...
				while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
					...
					self['getCellFormatter']()['addStyleName']((typeof ($add7=row)==typeof ($add8=$constant_int_1) && (typeof $add7=='number'||typeof $add7=='string')?
						$add7+$add8:
						$p['op_add']($add7,$add8)), $constant_int_0, 'gwt-BorderCell');
	...
	, 1, [null,null,['self'],['rows'],['cols']]);
			...
			$method = $pyjs__bind_method2('setColLabelValue', function(col, value) {
				...
				var $add14,$add13;
				self['setHTML']($constant_int_0, (typeof ($add13=col)==typeof ($add14=$p['getattr'](self, 'left')) && (typeof $add13=='number'||typeof $add13=='string')?
					$add13+$add14:
	...
	, 1, [null,null,['self'],['row'],['value']]);
			...
			$method = $pyjs__bind_method2('setCellValue', function(row, col, value) {
				...
				var $add20,$bool3,$add17,$add19,$4,$add18,$3;
				...
				if ((($bool3=$p['op_eq'](value, '')) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
	...
	, 1, [null,null,['self'],['row']]);
			...
			$method = $pyjs__bind_method2('styleRow', function(row, selected) {
				...
				if ((($bool5=((($bool4=$and1=((($cmp1=row)===($cmp2=$constant_int_0)?0:
	...
	return this;
}; /* end libtimesheet.view.components.Grid */


/* end module: libtimesheet.view.components.Grid */
