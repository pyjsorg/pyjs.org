...
$pyjs['loaded_modules']['pyjamas.chart.GChartConsts'] = function (__mod_name__) {
	...
	try {
		...
		$m['DEFAULT_BLANK_IMAGE_URL_FULLPATH'] = (typeof ($add1=$m['pygwt']['getImageBaseURL'](true))==typeof ($add2=$m['DEFAULT_BLANK_IMAGE_URL']) && (typeof $add1=='number'||typeof $add1=='string')?
			$add1+$add2:
			$p['op_add']($add1,$add2));
