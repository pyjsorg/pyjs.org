/* start module: cssauto */
$pyjs['loaded_modules']['cssauto'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['cssauto']['__was_initialized__']) return $pyjs['loaded_modules']['cssauto'];
	var $m = $pyjs['loaded_modules']['cssauto'];
	$m['__repr__'] = function() { return '<module: cssauto>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'cssauto';
	...
	try {
		...
		$m['App'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'cssauto';
			$cls_definition['__md5__'] = '964ecab2d0606ba1c4e838af211efaa9';
			$method = $pyjs__bind_method2('onModuleLoad', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '964ecab2d0606ba1c4e838af211efaa9') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				}
				var b,text,df1,df3,df2,vp;
				text = $m['TextBox']();
				df1 = $m['DateField']();
				...
				(typeof $bool1=='object'?
					(typeof $bool1['__nonzero__']=='function'?
						...
						(typeof $bool1['__len__']=='function'?
							...
							true ) ) :
					 true ) )) {
			$m['pyjd']['setup']('./public/cssauto.html');
			$m['app'] = $m['App']();
			$m['app']['onModuleLoad']();
			$m['pyjd']['run']();
		}
...
/*
PYJS_DEPS: ['pyjd', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.RootPanel.RootPanel', 'pyjamas.ui.RootPanel', 'pyjamas.ui.TextBox.TextBox', 'pyjamas.ui.TextBox', 'pyjamas.ui.Button.Button', 'pyjamas.ui.Button', 'pyjamas.ui.Calendar.DateField', 'pyjamas.ui.Calendar', 'pyjamas.ui.Calendar.Calendar', 'pyjamas.ui.Calendar.CalendarPopup', 'pyjamas.ui.MonthField.MonthField', 'pyjamas.ui.MonthField']
*/
