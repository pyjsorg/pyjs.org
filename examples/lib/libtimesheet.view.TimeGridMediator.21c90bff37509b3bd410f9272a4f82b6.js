/* start module: libtimesheet.view.TimeGridMediator */
$pyjs['loaded_modules']['libtimesheet.view.TimeGridMediator'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.TimeGridMediator']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.TimeGridMediator'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.TimeGridMediator'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.TimeGridMediator>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.TimeGridMediator';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view']['TimeGridMediator'] = $pyjs['loaded_modules']['libtimesheet.view.TimeGridMediator'];
	try {
		...
		$m['TimeVO'] = $p['___import___']('libtimesheet.model.vo.TimeVO.TimeVO', 'libtimesheet.view', null, false);
		$m['setCookie'] = $p['___import___']('pyjamas.Cookies.setCookie', 'libtimesheet.view', null, false);
		$m['alert'] = $p['___import___']('pyjamas.Window.alert', 'libtimesheet.view', null, false);
		$m['TimeGridMediator'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.TimeGridMediator';
			$cls_definition['__md5__'] = 'b076a5f54627f5c46ee9a691dd452f10';
			...
			$method = $pyjs__bind_method2('__init__', function(viewComponent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'b076a5f54627f5c46ee9a691dd452f10') {
	...
	return this;
}; /* end libtimesheet.view.TimeGridMediator */


/* end module: libtimesheet.view.TimeGridMediator */


/*
PYJS_DEPS: ['puremvc.patterns.mediator.Mediator', 'puremvc', 'puremvc.patterns', 'puremvc.patterns.mediator', 'libtimesheet.ApplicationConstants.Notification', 'libtimesheet', 'libtimesheet.ApplicationConstants', 'libtimesheet.model', 'libtimesheet.model.TimeProxy.TimeProxy', 'libtimesheet.model.TimeProxy', 'libtimesheet.model.vo.TimeVO.TimeVO', 'libtimesheet.model.vo', 'libtimesheet.model.vo.TimeVO', 'pyjamas.Cookies.setCookie', 'pyjamas', 'pyjamas.Cookies', 'pyjamas.Window.alert', 'pyjamas.Window']
*/
