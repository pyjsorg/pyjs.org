...
$pyjs['loaded_modules']['puremvc.patterns.facade'] = function (__mod_name__) {
	...
	try {
		...
		$m['Facade'] = (function(){
			...
			$cls_definition['__md5__'] = 'f119f081c16c02aa62688dc6844f53ba';
						...
						(typeof $bool4=='object'?
							(typeof $bool4['__nonzero__']=='function'?
								...
								(typeof $bool4['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					cls['__is_instance__'] && typeof cls['__setattr__'] == 'function' ? cls['__setattr__']('instance', $pyjs_kwargs_call($p['$$super']($m['Facade'], cls), '__new__', args, kwargs, [{}, cls])) : $p['setattr'](cls, 'instance', $pyjs_kwargs_call($p['$$super']($m['Facade'], cls), '__new__', args, kwargs, [{}, cls])); 
	...
	, 3, [null,null]);
			...
			$method = $pyjs__bind_method2('initializeFacade', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'f119f081c16c02aa62688dc6844f53ba') {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('initializeController', function() {
				...
				var $bool5;
				if ((($bool5=!$p['op_is']($p['getattr'](self, 'controller'), null)) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('controller', $m['puremvc']['core']['Controller']['getInstance']()) : $p['setattr'](self, 'controller', $m['puremvc']['core']['Controller']['getInstance']()); 
				return null;
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('initializeModel', function() {
				...
				var $bool6;
				if ((($bool6=!$p['op_is']($p['getattr'](self, 'model'), null)) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
						false :
						(typeof $bool6=='object'?
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('model', $m['puremvc']['core']['Model']['getInstance']()) : $p['setattr'](self, 'model', $m['puremvc']['core']['Model']['getInstance']()); 
				return null;
			}
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('initializeView', function() {
				...
				var $bool7;
				if ((($bool7=!$p['op_is']($p['getattr'](self, 'view'), null)) === null || $bool7 === false || $bool7 === 0 || $bool7 === '' ?
						false :
						(typeof $bool7=='object'?
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('view', $m['puremvc']['core']['View']['getInstance']()) : $p['setattr'](self, 'view', $m['puremvc']['core']['View']['getInstance']()); 
				return null;
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['proxyName']]);
			...
			$method = $pyjs__bind_method2('removeProxy', function(proxyName) {
				...
				var $bool8,proxy;
				proxy = null;
				if ((($bool8=!$p['op_is']($p['getattr'](self, 'model'), null)) === null || $bool8 === false || $bool8 === 0 || $bool8 === '' ?
						false :
						(typeof $bool8=='object'?
	...
	, 1, [null,null,['self'],['proxyName']]);
			...
			$method = $pyjs__bind_method2('registerMediator', function(mediator) {
				...
				var $bool9;
				if ((($bool9=!$p['op_is']($p['getattr'](self, 'view'), null)) === null || $bool9 === false || $bool9 === 0 || $bool9 === '' ?
						false :
						(typeof $bool9=='object'?
	...
	, 1, [null,null,['self'],['mediatorName']]);
			...
			$method = $pyjs__bind_method2('removeMediator', function(mediatorName) {
				...
				var $bool10,mediator;
				mediator = null;
				if ((($bool10=!$p['op_is']($p['getattr'](self, 'view'), null)) === null || $bool10 === false || $bool10 === 0 || $bool10 === '' ?
						false :
	...
	, 1, [null,null,['self'],['notificationName'],['body', null],['type', null]]);
			...
			$method = $pyjs__bind_method2('notifyObservers', function(notification) {
				...
				var $bool11;
				if ((($bool11=!$p['op_is']($p['getattr'](self, 'view'), null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
