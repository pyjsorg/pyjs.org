/* start module: libtimesheet.view.components.Summary */
$pyjs['loaded_modules']['libtimesheet.view.components.Summary'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.components.Summary']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.components.Summary'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.components.Summary'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.components.Summary>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.components.Summary';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view.components']['Summary'] = $pyjs['loaded_modules']['libtimesheet.view.components.Summary'];
	try {
		...
		$m['time'] = $p['___import___']('time', 'libtimesheet.view.components');
		$m['Summary'] = (function(){
			var $cls_definition = new Object();
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.components.Summary';
			$cls_definition['__md5__'] = '37ca489c8da53d63f6659d489d604d56';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '37ca489c8da53d63f6659d489d604d56') {
	...
	return this;
}; /* end libtimesheet.view.components.Summary */


/* end module: libtimesheet.view.components.Summary */


/*
PYJS_DEPS: ['libtimesheet.ApplicationConstants.Notification', 'libtimesheet', 'libtimesheet.ApplicationConstants', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.FlexTable.FlexTable', 'pyjamas.ui.FlexTable', 'pyjamas.ui.Label.Label', 'pyjamas.ui.Label', 'Grid.Grid', 'Grid', 'time']
*/
