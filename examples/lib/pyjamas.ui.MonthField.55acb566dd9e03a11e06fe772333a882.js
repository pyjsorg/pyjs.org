...
$pyjs['loaded_modules']['pyjamas.ui.MonthField'] = function (__mod_name__) {
	...
	try {
		...
		$m['NoDaysCalendar'] = (function(){
			...
			$cls_definition['__md5__'] = '036d3c4c80659b5b791ccdd894fd7834';
			...
			$method = $pyjs__bind_method2('drawGrid', function(month, year) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '036d3c4c80659b5b791ccdd894fd7834') {
	...
	, 1, [null,null,['self'],['event']]);
		...
		$m['MonthField'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.ui.MonthField';
			$cls_definition['__md5__'] = '202d73d6bcce74469190a98adca1b483';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '202d73d6bcce74469190a98adca1b483') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
