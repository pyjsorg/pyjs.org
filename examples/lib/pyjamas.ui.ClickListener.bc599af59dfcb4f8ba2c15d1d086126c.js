...
$pyjs['loaded_modules']['pyjamas.ui.ClickListener'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
				...
				var listener,$iter2_nextval,$iter1_nextval,$iter1_type,$iter2_iter,$bool7,$iter1_iter,$bool2,$bool3,$iter2_idx,$bool6,$iter1_array,$bool4,$bool5,$iter2_type,type,$iter2_array,$iter1_idx;
				type = $m['DOM']['eventGetType'](event);
				if ((($bool2=$p['op_eq'](type, 'click')) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
						false :
						(typeof $bool2=='object'?
							(typeof $bool2['__nonzero__']=='function'?
								...
								(typeof $bool2['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool3=$p['getattr'](self, '_clickPreventDefault')) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
							false :
							(typeof $bool3=='object'?
				...
				else if ((($bool5=$p['op_eq'](type, 'dblclick')) === null || $bool5 === false || $bool5 === 0 || $bool5 === '' ?
						false :
						(typeof $bool5=='object'?
							(typeof $bool5['__nonzero__']=='function'?
								...
								(typeof $bool5['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool6=$p['getattr'](self, '_clickPreventDefault')) === null || $bool6 === false || $bool6 === 0 || $bool6 === '' ?
							false :
							(typeof $bool6=='object'?
