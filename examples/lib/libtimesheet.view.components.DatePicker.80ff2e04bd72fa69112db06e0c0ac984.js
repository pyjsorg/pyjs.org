/* start module: libtimesheet.view.components.DatePicker */
$pyjs['loaded_modules']['libtimesheet.view.components.DatePicker'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.components.DatePicker']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.components.DatePicker'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.components.DatePicker'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.components.DatePicker>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.components.DatePicker';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view.components']['DatePicker'] = $pyjs['loaded_modules']['libtimesheet.view.components.DatePicker'];
	try {
		...
		$m['DatePicker'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.components.DatePicker';
			$cls_definition['__md5__'] = '1274664bf490f81f97992f151e1c7afa';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '1274664bf490f81f97992f151e1c7afa') {
	...
	return this;
}; /* end libtimesheet.view.components.DatePicker */


/* end module: libtimesheet.view.components.DatePicker */


/*
PYJS_DEPS: ['libtimesheet.ApplicationConstants.Notification', 'libtimesheet', 'libtimesheet.ApplicationConstants', 'pyjamas.ui.HorizontalPanel.HorizontalPanel', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.HorizontalPanel', 'pyjamas.ui.Button.Button', 'pyjamas.ui.Button', 'pyjamas.ui.TextBox.TextBox', 'pyjamas.ui.TextBox', 'time']
*/
