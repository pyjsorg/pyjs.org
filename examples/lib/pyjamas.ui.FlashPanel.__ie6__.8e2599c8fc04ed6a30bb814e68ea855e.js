...
$pyjs['loaded_modules']['pyjamas.ui.FlashPanel'] = function (__mod_name__) {
	...
	try {
		...
		$m['FlashPanel'] = (function(){
			...
			$cls_definition['__md5__'] = 'd992d111d58777a142949ff6b6fecfb8';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'd992d111d58777a142949ff6b6fecfb8') {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('callFlash', function(functionName, $$arguments) {
				...
				var $bool18,$bool19,$add67,$add66,$add65,$add68,returnString,$pyjs_try_err,$bool21,$$arguments,returnValue,movieElement,$bool20;
				...
				try {
					returnString = movieElement['CallFunction']($p['sprintf']('<invoke name="%s" returntype="javascript">%s</invoke>', $p['tuple']([functionName, self['flashArgumentsToXML']($$arguments, $constant_int_0)])));
					returnValue = '';
							...
							(typeof $bool20=='object'?
								(typeof $bool20['__nonzero__']=='function'?
									...
									(typeof $bool20['__len__']=='function'?
										...
										true ) ) :
								 true ) )) {
						if ((($bool21=!$p['op_eq'](returnString, 'undefined')) === null || $bool21 === false || $bool21 === 0 || $bool21 === '' ?
								false :
