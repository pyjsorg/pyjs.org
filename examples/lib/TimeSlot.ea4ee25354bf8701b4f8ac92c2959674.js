...
$pyjs['loaded_modules']['TimeSlot'] = function (__mod_name__) {
	...
	try {
		...
		$m['TimeSlot'] = (function(){
			...
			$cls_definition['__md5__'] = '4791a8c0907cce386605d8c50002bd3f';
			$method = $pyjs__bind_method2('__init__', function(dayOfWeek, startMinutes, endMinutes) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '4791a8c0907cce386605d8c50002bd3f') {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('DAYS', $p['list'](['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'])) : $p['setattr'](self, 'DAYS', $p['list'](['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'])); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('dayOfWeek', dayOfWeek) : $p['setattr'](self, 'dayOfWeek', dayOfWeek); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('startMinutes', startMinutes) : $p['setattr'](self, 'startMinutes', startMinutes); 
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('endMinutes', endMinutes) : $p['setattr'](self, 'endMinutes', endMinutes); 
				return null;
			}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getHrsMins', function(mins) {
				...
				hrs = $m['math']['floor']((typeof ($div1=mins)==typeof ($div2=$constant_int_60) && typeof $div1=='number' && $div2 !== 0?
					$div1/$div2:
					$p['op_div']($div1,$div2)));
				if ((($bool5=((($cmp9=hrs)===($cmp10=$constant_int_12)?0:
						...
						(typeof $bool5=='object'?
							(typeof $bool5['__nonzero__']=='function'?
								...
								(typeof $bool5['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					hrs = (typeof ($sub1=hrs)==typeof ($sub2=$constant_int_12) && (typeof $sub1=='number'||typeof $sub1=='string')?
						$sub1-$sub2:
						$p['op_sub']($sub1,$sub2));
				}
				remainder = $m['math']['floor']((typeof ($mod1=mins)==typeof ($mod2=$constant_int_60) && typeof $mod1=='number'?
					(($mod1=$mod1%$mod2)<0&&$mod2>0?$mod1+$mod2:$mod1):
					$p['op_mod']($mod1,$mod2)));
				if ((($bool6=((($cmp11=remainder)===($cmp12=$constant_int_10)?0:
