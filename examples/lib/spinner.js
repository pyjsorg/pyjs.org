...
$pyjs.loaded_modules['spinner'] = function (__mod_name__) {
	...
	try {
		...
		$m['Spinner'] = (function(){
			...
			$cls_definition.__md5__ = 'c62fed3af4c290b31ae3227fc6178ac8';
			$method = $pyjs__bind_method2('__init__', function(width, height) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'c62fed3af4c290b31ae3227fc6178ac8') {
				...
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('width', $constant_int_15) : $p['setattr'](self, 'width', $constant_int_15); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('r1', $constant_int_35) : $p['setattr'](self, 'r1', $constant_int_35); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('r2', $constant_int_60) : $p['setattr'](self, 'r2', $constant_int_60); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('cx', (typeof ($add1=$p['getattr'](self, 'r2'))==typeof ($add2=$p['getattr'](self, 'width')) && (typeof $add1=='number'||typeof $add1=='string')?
					$add1+$add2:
					$p['op_add']($add1,$add2))) : $p['setattr'](self, 'cx', (typeof ($add1=$p['getattr'](self, 'r2'))==typeof ($add2=$p['getattr'](self, 'width')) && (typeof $add1=='number'||typeof $add1=='string')?
					$add1+$add2:
					$p['op_add']($add1,$add2))); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('cy', (typeof ($add3=$p['getattr'](self, 'r2'))==typeof ($add4=$p['getattr'](self, 'width')) && (typeof $add3=='number'||typeof $add3=='string')?
					$add3+$add4:
					$p['op_add']($add3,$add4))) : $p['setattr'](self, 'cy', (typeof ($add3=$p['getattr'](self, 'r2'))==typeof ($add4=$p['getattr'](self, 'width')) && (typeof $add3=='number'||typeof $add3=='string')?
					$add3+$add4:
					$p['op_add']($add3,$add4))); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('numSectors', $constant_int_12) : $p['setattr'](self, 'numSectors', $constant_int_12); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('canvas', $m['Raphael']((typeof ($add5=(typeof ($mul1=$p['getattr'](self, 'r2'))==typeof ($mul2=$constant_int_2) && typeof $mul1=='number'?
					$mul1*$mul2:
					$p['op_mul']($mul1,$mul2)))==typeof ($add6=(typeof ($mul3=$p['getattr'](self, 'width'))==typeof ($mul4=$constant_int_2) && typeof $mul3=='number'?
					$mul3*$mul4:
					$p['op_mul']($mul3,$mul4))) && (typeof $add5=='number'||typeof $add5=='string')?
					$add5+$add6:
					$p['op_add']($add5,$add6)), (typeof ($add7=(typeof ($mul5=$p['getattr'](self, 'r2'))==typeof ($mul6=$constant_int_2) && typeof $mul5=='number'?
					$mul5*$mul6:
					$p['op_mul']($mul5,$mul6)))==typeof ($add8=(typeof ($mul7=$p['getattr'](self, 'width'))==typeof ($mul8=$constant_int_2) && typeof $mul7=='number'?
					$mul7*$mul8:
					$p['op_mul']($mul7,$mul8))) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					$p['op_add']($add7,$add8)))) : $p['setattr'](self, 'canvas', $m['Raphael']((typeof ($add5=(typeof ($mul1=$p['getattr'](self, 'r2'))==typeof ($mul2=$constant_int_2) && typeof $mul1=='number'?
					$mul1*$mul2:
					$p['op_mul']($mul1,$mul2)))==typeof ($add6=(typeof ($mul3=$p['getattr'](self, 'width'))==typeof ($mul4=$constant_int_2) && typeof $mul3=='number'?
					$mul3*$mul4:
					$p['op_mul']($mul3,$mul4))) && (typeof $add5=='number'||typeof $add5=='string')?
					...
					$add7+$add8:
					$p['op_add']($add7,$add8)))); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('sectors', $p['list']([])) : $p['setattr'](self, 'sectors', $p['list']([])); 
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('opacity', $p['list']([])) : $p['setattr'](self, 'opacity', $p['list']([])); 
	...
	, 1, [null,null,['self'],['width', $constant_int_600],['height', $constant_int_300]]);
			...
			$method = $pyjs__bind_method2('draw', function() {
				...
				colour = '#000000';
				beta = (typeof ($div1=(typeof ($mul9=$constant_int_2)==typeof ($mul10=$p['getattr']($m['math'], 'pi')) && typeof $mul9=='number'?
					$mul9*$mul10:
				...
				while (typeof ($iter1_nextval=($iter1_type?($iter1_type > 0?$iter1_iter.next(true,false):$p['wrapped_next']($iter1_iter)):$iter1_array[$iter1_idx++])) != 'undefined') {
					...
					alpha = (typeof ($sub1=(typeof ($mul11=beta)==typeof ($mul12=i) && typeof $mul11=='number'?
						$mul11*$mul12:
						$p['op_mul']($mul11,$mul12)))==typeof ($sub2=(typeof ($div3=$p['getattr']($m['math'], 'pi'))==typeof ($div4=$constant_int_2) && typeof $div3=='number' && $div4 !== 0?
						$div3/$div4:
				...
				period = (typeof ($div7=$constant_int_1000)==typeof ($div8=$p['getattr'](self, 'numSectors')) && typeof $div7=='number' && $div8 !== 0?
					$div7/$div8:
					$p['op_div']($div7,$div8));
				self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('_timer', $pyjs_kwargs_call(null, $m['Timer'], null, null, [{notify:self}])) : $p['setattr'](self, '_timer', $pyjs_kwargs_call(null, $m['Timer'], null, null, [{notify:self}])); 
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onTimer', function(timerID) {
				...
				self['opacity']['insert']($constant_int_0, self['opacity']['pop']());
