...
$pyjs['loaded_modules']['demoInfo'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('showDialog', function(event) {
			...
			var $add9,$sub4,top,$add8,$div7,$div8,$add10,$add7,$sub3,$sub2,$sub1,left,$div6,contents,$div5;
			...
			left = $p['__op_add']($add7=(typeof ($div5=$p['__op_sub']($sub1=$m['Window']['getClientWidth'](),$sub2=200))==typeof ($div6=2) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
				$p['op_div']($div5,$div6)),$add8=$m['Window']['getScrollLeft']());
			top = $p['__op_add']($add9=(typeof ($div7=$p['__op_sub']($sub3=$m['Window']['getClientHeight'](),$sub4=100))==typeof ($div8=2) && typeof $div7=='number' && $div8 !== 0?
				$div7/$div8:
				$p['op_div']($div7,$div8)),$add10=$m['Window']['getScrollTop']());
