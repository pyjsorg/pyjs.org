...
$pyjs.loaded_modules['pyjamas.dnd.DragEvent'] = function (__mod_name__) {
	...
	try {
		...
		$m['DragEvent'] = (function(){
			...
			$cls_definition.__md5__ = '5af09b45b22fae89aaaa8b6bab81d72f';
			...
			$method = $pyjs__bind_method2('__init__', function(evt, type, dataTransfer, target) {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== '5af09b45b22fae89aaaa8b6bab81d72f') {
						...
						(typeof $bool2=='object'?
							(typeof $bool2.__nonzero__=='function'?
								...
								(typeof $bool2.__len__=='function'?
									...
									true ) ) :
							 true ) )) {
					self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('srcElement', target) : $p['setattr'](self, 'srcElement', target); 
				}
				else {
					self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('srcElement', $m['DOM']['eventGetTarget']($p['getattr'](self, 'evt'))) : $p['setattr'](self, 'srcElement', $m['DOM']['eventGetTarget']($p['getattr'](self, 'evt'))); 
				}
				return null;
			}
