...
$pyjs['loaded_modules']['pyjamas.ui.ChangeListener'] = function (__mod_name__) {
	...
	try {
		...
		$m['fireChangeEvent'] = function(listeners, sender, event) {
			...
			var $bool2,$iter1_nextval,$iter1_idx,$iter1_iter,listener,$bool1,$iter1_array,etype,$iter1_type;
			etype = $m['DOM']['eventGetType'](event);
			if ((($bool1=!$p['op_eq'](etype, 'change')) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
					false :
					(typeof $bool1=='object'?
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
				...
				var etype,$bool3;
				etype = $m['DOM']['eventGetType'](event);
				if ((($bool3=$p['op_eq'](etype, 'change')) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
