...
$pyjs['loaded_modules']['pyjamas.ui.Widget'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('setContextMenu', function(menu) {
				...
				if ((($bool1=!$p['op_is'](menu, null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
	...
	, 1, [null,null,['self'],['menu']]);
			...
			$method = $pyjs__bind_method2('onBrowserEvent', function(event) {
				...
				var $bool10,$bool11,$bool2,$bool3,$bool12,$bool6,$bool7,$bool4,$bool5,$bool8,$bool9,type;
				...
				if ((($bool11=$p['op_is']($p['getattr'](self, 'contextMenu'), null)) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
						false :
				...
				if ((($bool12=$p['op_eq'](type, 'contextmenu')) === null || $bool12 === false || $bool12 === 0 || $bool12 === '' ?
						false :
	...
	, 1, [null,null,['self'],['layoutData']]);
			...
			$method = $pyjs__bind_method2('setParent', function(parent) {
				...
				if ((($bool16=$p['op_is'](parent, null)) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
						false :
						(typeof $bool16=='object'?
							(typeof $bool16['__nonzero__']=='function'?
								...
								(typeof $bool16['__len__']=='function'?
									...
									true ) ) :
							 true ) )) {
					if ((($bool18=((($bool17=$and1=!$p['op_is'](oldparent, null)) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
						false :
