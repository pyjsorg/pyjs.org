...
$pyjs.loaded_modules['demoInfo'] = function (__mod_name__) {
	...
	$m['ScrollPanelDemo'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			var $add11,vert,panel2,$mul8,$add14,$add15,$add16,$add17,$add10,$add7,$add12,$add13,$mul7,container,$add8,$add9,$add18,contents2,contents,panel;
			$m['SimplePanel']['__init__'](self);
			vert = $m['VerticalPanel']();
			vert['setSpacing']('10px');
			self['add'](vert);
			panel = $pyjs_kwargs_call(null, $m['ScrollPanel'], null, null, [{Size:$p['tuple'](['300px', '100px'])}]);
			contents = $m['HTML']($p['__op_add']($add17=$p['__op_add']($add15=$p['__op_add']($add13=$p['__op_add']($add11=$p['__op_add']($add9=$p['__op_add']($add7='<b>Tao Te Ching, Chapter One</b><p>',$add8='The Way that can be told of is not an unvarying '),$add10='way;<p>The names that can be named are not '),$add12='unvarying names.<p>It was from the Nameless that '),$add14='Heaven and Earth sprang;<p>The named is but the '),$add16='mother that rears the ten thousand creatures, '),$add18='each after its kind.'));
			panel['add'](contents);
			vert['add'](panel);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('showDialog', function(event) {
			...
			var $sub4,$add21,$add20,$add22,$add19,top,$div8,$div7,$sub3,$sub2,$sub1,left,$div6,contents,$div5;
			...
			left = $p['__op_add']($add19=(typeof ($div5=$p['__op_sub']($sub1=$m['Window']['getClientWidth'](),$sub2=200))==typeof ($div6=2) && typeof $div5=='number' && $div6 !== 0?
				$div5/$div6:
				$p['op_div']($div5,$div6)),$add20=$m['Window']['getScrollLeft']());
			top = $p['__op_add']($add21=(typeof ($div7=$p['__op_sub']($sub3=$m['Window']['getClientHeight'](),$sub4=100))==typeof ($div8=2) && typeof $div7=='number' && $div8 !== 0?
				$div7/$div8:
				$p['op_div']($div7,$div8)),$add22=$m['Window']['getScrollTop']());
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('onList1ItemSelected', function(event) {
			...
			var $add25,$add24,$add26,item,$add23;
			item = self['list1']['getItemText'](self['list1']['getSelectedIndex']());
			$m['Window']['alert']($p['__op_add']($add25=$p['__op_add']($add23='You selected ',$add24=item),$add26=' from list 1'));
			return null;
		}
	, 1, [null,null,['self'],['event']]);
		...
		$method = $pyjs__bind_method2('onList2ItemSelected', function(event) {
			...
			$m['Window']['alert']($p['__op_add']($add29=$p['__op_add']($add27='You selected ',$add28=item),$add30=' from list 2'));
			return null;
		}
	, 1, [null,null,['self'],['event']]);
	...
	$m['GridDemo'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			var $iter3_type,row,$iter3_idx,$iter2_iter,$iter3_iter,$iter2_type,$iter2_idx,grid,$mul9,$iter3_array,$iter3_nextval,$add38,$iter2_nextval,$mul10,$add32,$add33,$add31,$add36,$add37,$add34,$add35,col,$iter2_array;
			$m['SimplePanel']['__init__'](self);
			...
			while (typeof($p['__wrapped_next']($iter2_nextval).$nextval) != 'undefined') {
				...
				while (typeof($p['__wrapped_next']($iter3_nextval).$nextval) != 'undefined') {
					...
					grid['setText'](row, col, $p['__op_add']($add37=$p['__op_add']($add35=$p['__op_add']($add33=$p['__op_add']($add31=$p['str'](row),$add32='*'),$add34=$p['str'](col)),$add36=' = '),$add38=$p['str']((typeof ($mul9=row)==typeof ($mul10=col) && typeof $mul9=='number'?
						$mul9*$mul10:
						$p['op_mul']($mul9,$mul10)))));
				}
			}
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('showPopup', function(event) {
			...
			var $add39,top,$add42,$add41,$add40,contents,left;
			...
			left = $p['__op_add']($add39=self['_btn']['getAbsoluteLeft'](),$add40=10);
			top = $p['__op_add']($add41=self['_btn']['getAbsoluteTop'](),$add42=10);
...
/*
PYJS_DEPS: ['pyjamas.ui.DialogBox.DialogBox', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.DialogBox', 'pyjamas.ui.HTML.HTML', 'pyjamas.ui.HTML', 'pyjamas.ui.SimplePanel.SimplePanel', 'pyjamas.ui.SimplePanel', 'pyjamas.ui.HTMLPanel.HTMLPanel', 'pyjamas.ui.HTMLPanel', 'pyjamas.ui.CaptionPanel.CaptionPanel', 'pyjamas.ui.CaptionPanel', 'pyjamas.ui.Frame.Frame', 'pyjamas.ui.Frame', 'pyjamas.ui.TreeItem.TreeItem', 'pyjamas.ui.TreeItem', 'pyjamas.DOM', 'pyjamas.ui.Button.Button', 'pyjamas.ui.Button', 'math', 'pyjamas.ui.TabPanel.TabPanel', 'pyjamas.ui.TabPanel', 'pyjamas.ui.TextArea.TextArea', 'pyjamas.ui.TextArea', 'pyjamas.ui.NamedFrame.NamedFrame', 'pyjamas.ui.NamedFrame', 'pyjamas.History', 'pyjamas.ui.HasAlignment', 'pyjamas.ui.TextBox.TextBox', 'pyjamas.ui.TextBox', 'pyjamas.ui.ScrollPanel.ScrollPanel', 'pyjamas.ui.ScrollPanel', 'pyjamas.ui.PopupPanel.PopupPanel', 'pyjamas.ui.PopupPanel', 'pyjamas.ui.MenuBar.MenuBar', 'pyjamas.ui.MenuBar', 'pyjamas.ui.PasswordTextBox.PasswordTextBox', 'pyjamas.ui.PasswordTextBox', 'pyjamas.ui.FileUpload.FileUpload', 'pyjamas.ui.FileUpload', 'pyjamas.ui.AbsolutePanel.AbsolutePanel', 'pyjamas.ui.AbsolutePanel', 'pyjamas.ui.MenuItem.MenuItem', 'pyjamas.ui.MenuItem', 'pyjamas.ui.ListBox.ListBox', 'pyjamas.ui.ListBox', 'pyjamas.ui.Grid.Grid', 'pyjamas.ui.Grid', 'pyjamas.ui.StackPanel.StackPanel', 'pyjamas.ui.StackPanel', 'pyjamas.ui.FlowPanel.FlowPanel', 'pyjamas.ui.FlowPanel', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.RadioButton.RadioButton', 'pyjamas.ui.RadioButton', 'pyjamas.ui.Hidden.Hidden', 'pyjamas.ui.Hidden', 'pyjamas.ui.Hyperlink.Hyperlink', 'pyjamas.ui.Hyperlink', 'pyjamas.Window', 'pyjamas.ui.Tree.Tree', 'pyjamas.ui.Tree', 'pyjamas.ui.Image.Image', 'pyjamas.ui.Image', 'pyjamas.ui.Label.Label', 'pyjamas.ui.Label', 'pyjamas.ui.CheckBox.CheckBox', 'pyjamas.ui.CheckBox', 'pyjamas.ui.DockPanel.DockPanel', 'pyjamas.ui.DockPanel', 'pyjamas.ui.FormPanel.FormPanel', 'pyjamas.ui.FormPanel', 'pyjamas.ui.HorizontalPanel.HorizontalPanel', 'pyjamas.ui.HorizontalPanel', 'pyjamas.ui.FlexTable.FlexTable', 'pyjamas.ui.FlexTable']
*/
