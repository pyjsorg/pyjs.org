...
$pyjs['loaded_modules']['TimeSheet'] = function (__mod_name__) {
	...
	try {
		...
		$m['Notification'] = $p['___import___']('libtimesheet.ApplicationConstants.Notification', null, null, false);
		$m['StartupCommand'] = $p['___import___']('libtimesheet.controller.StartupCommand.StartupCommand', null, null, false);
		$m['AppFrame'] = $p['___import___']('libtimesheet.view.components.AppFrame.AppFrame', null, null, false);
...
/*
PYJS_DEPS: ['pyjd', 'puremvc.patterns.facade.Facade', 'puremvc', 'puremvc.patterns', 'puremvc.patterns.facade', 'pyjamas.Window.alert', 'pyjamas', 'pyjamas.Window', 'pyjamas.Timer.Timer', 'pyjamas.Timer', 'libtimesheet.ApplicationConstants.Notification', 'libtimesheet', 'libtimesheet.ApplicationConstants', 'libtimesheet.controller.StartupCommand.StartupCommand', 'libtimesheet.controller', 'libtimesheet.controller.StartupCommand', 'libtimesheet.view.components.AppFrame.AppFrame', 'libtimesheet.view', 'libtimesheet.view.components', 'libtimesheet.view.components.AppFrame']
*/
