...
$pyjs['loaded_modules']['pyjamas.JSONService'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['request']]);
			...
			$method = $pyjs__bind_method2('onCompletion', function(json_str) {
				...
				var $bool12,code,jsonrpc,$3,$bool11,$bool13,$bool14,$bool15,$bool16,data,$pyjs_try_err,error,$4,message,$bool17,$2,response,$1;
				try {
				...
				if ((($bool12=!(($bool11=response) === null || $bool11 === false || $bool11 === 0 || $bool11 === '' ?
					...
					if ((($bool15=!(($bool14=jsonrpc) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
						...
						if ((($bool16=$p['op_eq'](jsonrpc, '1.0')) === null || $bool16 === false || $bool16 === 0 || $bool16 === '' ?
								false :
			...
			$method = $pyjs__bind_method2('__call__', function() {
				...
				if ((($bool20=((($bool19=$and1=params) === null || $bool19 === false || $bool19 === 0 || $bool19 === '' ?
					...
					((typeof $5['__array'][$6=$constant_int_0]) != 'undefined'?$5['__array'][$6]:
						$5['__getitem__']($6)):
						$5['__getitem__']($constant_int_0)), 'onRemoteResponse'):$and1)) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
						false :
					...
					((typeof $7['__array'][$8=(typeof ($usub6=$constant_int_1)=='number'?
					-$usub6:
					$p['op_usub']($usub6))]) != 'undefined'?$7['__array'][$8]:
						$7['__getitem__']($8)):
						$7['__getitem__']((typeof ($usub6=$constant_int_1)=='number'?
					-$usub6:
				...
				if ((($bool27=!$p['op_is'](handler, null)) === null || $bool27 === false || $bool27 === 0 || $bool27 === '' ?
						false :
	...
	, 1, ['params',['kwargs'],['self']]);
		...
		$m['JSONProxy'] = (function(){
			...
			$method = $pyjs__bind_method2('__init__', function(url, methods, headers) {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('headers', ((($bool28=$p['op_is'](headers, null)) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
					false :
						...
						(typeof $bool28['__nonzero__']=='function'?
							...
							(typeof $bool28['__len__']=='function'?
								($bool28['__len__']()>0 ?
									...
									false) :
								true ) ) :
						 true ) )? ($p['dict']([])) : (headers))) : $p['setattr'](self, 'headers', ((($bool28=$p['op_is'](headers, null)) === null || $bool28 === false || $bool28 === 0 || $bool28 === '' ?
					false :
					(typeof $bool28=='object'?
						(typeof $bool28['__nonzero__']=='function'?
							$bool28['__nonzero__']() :
