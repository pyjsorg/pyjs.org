...
$pyjs.loaded_modules['pyjamas.ui.VerticalSplitPanel'] = function (__mod_name__) {
	...
	try {
		...
		$m['VerticalSplitPanel'] = (function(){
			...
			$cls_definition.__md5__ = 'a3eda18b434fb6e05dfc016d3dec5e60';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs.options.arg_instance_type) {
					if (self.prototype.__md5__ !== 'a3eda18b434fb6e05dfc016d3dec5e60') {
	...
	, 1, [null,['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('setTopWidget', function(topWidget) {
				...
				self['setWidget']($constant_int_0, topWidget);
				return null;
			}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('setBottomWidget', function(botWidget) {
				...
				self['setWidget']($constant_int_1, botWidget);
				return null;
			}
