...
$pyjs['loaded_modules']['KitchenSink'] = function (__mod_name__) {
	...
	try {
		...
		$m['Info'] = $p['___import___']('sink.Info', null, null, false);
		$m['Buttons'] = $p['___import___']('sink.Buttons', null, null, false);
		$m['Layouts'] = $p['___import___']('sink.Layouts', null, null, false);
		$m['Images'] = $p['___import___']('sink.Images', null, null, false);
		$m['Menus'] = $p['___import___']('sink.Menus', null, null, false);
		$m['Lists'] = $p['___import___']('sink.Lists', null, null, false);
		$m['Popups'] = $p['___import___']('sink.Popups', null, null, false);
		$m['Tables'] = $p['___import___']('sink.Tables', null, null, false);
		$m['Text'] = $p['___import___']('sink.Text', null, null, false);
		$m['Trees'] = $p['___import___']('sink.Trees', null, null, false);
		$m['Frames'] = $p['___import___']('sink.Frames', null, null, false);
		$m['Tabs'] = $p['___import___']('sink.Tabs', null, null, false);
		$m['Logger'] = $p['___import___']('sink.Logger.Logger', null, null, false);
...
/*
PYJS_DEPS: ['pyjd', 'pyjamas.logging', 'pyjamas', 'pyjamas.ui.Button.Button', 'pyjamas.ui', 'pyjamas.ui.Button', 'pyjamas.ui.RootPanel.RootPanel', 'pyjamas.ui.RootPanel', 'pyjamas.ui.HTML.HTML', 'pyjamas.ui.HTML', 'pyjamas.ui.DockPanel.DockPanel', 'pyjamas.ui.DockPanel', 'pyjamas.ui.HasAlignment', 'pyjamas.ui.Hyperlink.Hyperlink', 'pyjamas.ui.Hyperlink', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.Sink.SinkList', 'pyjamas.ui.Sink', 'pyjamas.History', 'pyjamas.Window', 'sink.Info', 'sink', 'sink.Buttons', 'sink.Layouts', 'sink.Images', 'sink.Menus', 'sink.Lists', 'sink.Popups', 'sink.Tables', 'sink.Text', 'sink.Trees', 'sink.Frames', 'sink.Tabs', 'sink.Logger.Logger', 'sink.Logger']
*/
