...
$pyjs['loaded_modules']['pyjamas.ui.FlowTabBar'] = function (__mod_name__) {
	...
	try {
		...
		$m['FlowTabBar'] = (function(){
			...
			$cls_definition['__md5__'] = 'de532d73cfdfcf89d26b5e6974d2c3cb';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'de532d73cfdfcf89d26b5e6974d2c3cb') {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('panel', $pyjs_kwargs_call(null, $m['FlowPanel'], null, null, [{'Element':element}])) : $p['setattr'](self, 'panel', $pyjs_kwargs_call(null, $m['FlowPanel'], null, null, [{'Element':element}])); 
	...
	, 1, [null,null,['self'],['text'],['asHTML'],['beforeIndex', null]]);
			...
			$method = $pyjs__bind_method2('insertTabWidget', function(widget, beforeIndex) {
				...
				self['panel']['insert'](delWidget, self['panel']['getElement'](), (typeof ($add3=beforeIndex)==typeof ($add4=$constant_int_1) && (typeof $add3=='number'||typeof $add3=='string')?
					$add3+$add4:
					$p['op_add']($add3,$add4)));
	...
	, 1, [null,null,['self'],['sender', null]]);
			...
			$method = $pyjs__bind_method2('removeTab', function(index) {
				...
				var $bool14,$add7,$add8,toRemove;
				self['checkTabIndex'](index);
				toRemove = self['panel']['getWidget']((typeof ($add7=index)==typeof ($add8=$constant_int_1) && (typeof $add7=='number'||typeof $add7=='string')?
					$add7+$add8:
					$p['op_add']($add7,$add8)));
				if ((($bool14=$p['op_eq'](toRemove, $p['getattr'](self, 'selectedTab'))) === null || $bool14 === false || $bool14 === 0 || $bool14 === '' ?
						false :
	...
	, 1, [null,null,['self'],['listener']]);
			...
			$method = $pyjs__bind_method2('selectTab', function(index) {
				...
				var $iter2_nextval,$iter2_type,$iter2_iter,$iter3_array,$bool15,$bool16,$bool17,listener,$iter2_idx,$iter3_idx,$add10,$iter3_iter,$iter3_type,$add9,$iter3_nextval,$iter2_array;
				self['checkTabIndex'](index);
				...
				if ((($bool17=$p['op_eq'](index, (typeof ($usub2=$constant_int_1)=='number'?
					-$usub2:
					$p['op_usub']($usub2)))) === null || $bool17 === false || $bool17 === 0 || $bool17 === '' ?
						false :
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('selectedTab', self['panel']['getWidget']((typeof ($add9=index)==typeof ($add10=$constant_int_1) && (typeof $add9=='number'||typeof $add9=='string')?
					$add9+$add10:
					$p['op_add']($add9,$add10)))) : $p['setattr'](self, 'selectedTab', self['panel']['getWidget']((typeof ($add9=index)==typeof ($add10=$constant_int_1) && (typeof $add9=='number'||typeof $add9=='string')?
					$add9+$add10:
					$p['op_add']($add9,$add10)))); 
	...
	, 1, [null,null,['self'],['index']]);
			...
			$method = $pyjs__bind_method2('checkTabIndex', function(index) {
				...
				if ((($bool19=((($bool18=$or3=((($cmp7=index)===($cmp8=(typeof ($usub3=$constant_int_1)=='number'?
					-$usub3:
					$p['op_usub']($usub3)))?0:
	...
	, 1, [null,null,['self'],['index']]);
			...
			$method = $pyjs__bind_method2('setSelectionStyle', function(item, selected) {
				...
				var $bool21,$bool20;
				if ((($bool20=!$p['op_is'](item, null)) === null || $bool20 === false || $bool20 === 0 || $bool20 === '' ?
						false :
