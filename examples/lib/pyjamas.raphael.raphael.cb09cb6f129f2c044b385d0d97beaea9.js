...
$pyjs['loaded_modules']['pyjamas.raphael.raphael'] = function (__mod_name__) {
	...
	try {
		...
		$m['RaphaelEventHandler'] = (function(){
			...
			$cls_definition['__md5__'] = '724538b729d925933d918d700597be34';
			$method = $pyjs__bind_method2('__init__', function(element) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '724538b729d925933d918d700597be34') {
	...
	, 1, [null,null,['self'],['event']]);
		...
		$m['Raphael'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = 'da4902f6d86b837742d64ee1319ba59f';
			$method = $pyjs__bind_method2('__init__', function(width, height) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'da4902f6d86b837742d64ee1319ba59f') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['obj1'],['obj2', null],['line', null],['bg', null],['cp1', null],['cp2', null],['p1', null],['p2', null]]);
		...
		$m['RaphaelElement'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = '0822a3942ab0721a7f70194b8063fc95';
			$method = $pyjs__bind_method2('__init__', function(raphaelElement) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0822a3942ab0721a7f70194b8063fc95') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['move'],['start'],['up']]);
			...
			$method = $pyjs__bind_method2('_onMove', function(dx, dy, x, y, event) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 5) $pyjs__exception_func_param(arguments['callee']['__name__'], 6, 6, arguments['length']+1);
				} else {
	...
	, 1, [null,null,['self'],['dx'],['dy'],['x'],['y'],['event']]);
			$cls_definition['_onMove'] = $method;
			$method = $pyjs__bind_method2('_onStart', function(x, y, event) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 3) $pyjs__exception_func_param(arguments['callee']['__name__'], 4, 4, arguments['length']+1);
				} else {
	...
	, 1, [null,null,['self'],['x'],['y'],['event']]);
			$cls_definition['_onStart'] = $method;
			$method = $pyjs__bind_method2('_onUp', function(event) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 2, 2, arguments['length']+1);
				} else {
	...
	, 1, [null,null,['self'],['event']]);
		...
		$m['RaphaelSetElement'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = '78dbca1d02a02f4c715355461ea24d06';
			$method = $pyjs__bind_method2('__init__', function(raphaelElement) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 2, 2, arguments['length']+1);
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '78dbca1d02a02f4c715355461ea24d06') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['type'],['listener']]);
		...
		$m['_DockConnection'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = '3c9fc60238b3c47eec65a4a8c4e92ec3';
		...
		$m['DOCK_CONNECTION'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = 'a8ef5f0ef05ab4cd902a3767a2d62fc6';
			$cls_definition['NORTH'] = $constant_int_0;
			$cls_definition['EAST'] = $constant_int_3;
			$cls_definition['SOUTH'] = $constant_int_1;
			$cls_definition['WEST'] = $constant_int_2;
		...
		$m['RaphaelConnectionElement'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = '9a704608f449f997bbee5ffce05458a1';
			$method = $pyjs__bind_method2('__init__', function(line_path, bg_path, obj1, obj2, line, bg, cp1, cp2, p1, p2) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '9a704608f449f997bbee5ffce05458a1') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['type'],['listener']]);
		...
		$m['RaphaelPathElement'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'pyjamas.raphael.raphael';
			$cls_definition['__md5__'] = '442ad860ab432bd03a8bbcb05fa4e451';
			var $bases = new Array($m['RaphaelElement']);
			var $data = $p['dict']();
			for (var $item in $cls_definition) { $data['__setitem__']($item, $cls_definition[$item]); }
