...
$pyjs['loaded_modules']['pyjamas.ui.Panel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getWidgetCount', function() {
				...
				var $len1;
				return (($len1=self['getChildren']()) === null?$constant_int_0:
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('setWidget', function(index, widget) {
				...
				if ((($bool1=!$p['op_is'](existing, null)) === null || $bool1 === false || $bool1 === 0 || $bool1 === '' ?
						false :
						(typeof $bool1=='object'?
	...
	, 1, [null,null,['self'],['index']]);
			...
			$method = $pyjs__bind_method2('__len__', function() {
				...
				var $len2;
				return (($len2=self['getChildren']()) === null?$constant_int_0:
	...
	, 1, [null,['kwargs'],['self']]);
			...
			$method = $pyjs__bind_method2('disown', function(widget) {
				...
				if ((($bool2=!$p['op_is'](widget['getParent'](), self)) === null || $bool2 === false || $bool2 === 0 || $bool2 === '' ?
						false :
						(typeof $bool2=='object'?
				...
				if ((($bool3=!$p['op_is'](parentElement, null)) === null || $bool3 === false || $bool3 === 0 || $bool3 === '' ?
						false :
						(typeof $bool3=='object'?
	...
	, 1, [null,null,['self'],['widget']]);
			...
			$method = $pyjs__bind_method2('adopt', function(widget, container) {
				...
				var $bool4;
				if ((($bool4=!$p['op_is'](container, null)) === null || $bool4 === false || $bool4 === 0 || $bool4 === '' ?
						false :
						(typeof $bool4=='object'?
