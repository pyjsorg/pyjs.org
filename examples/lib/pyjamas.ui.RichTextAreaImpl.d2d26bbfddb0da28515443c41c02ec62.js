...
$pyjs['loaded_modules']['pyjamas.ui.RichTextAreaImpl'] = function (__mod_name__) {
	...
	try {
		...
		$m['RichTextAreaImpl'] = (function(){
			...
			$cls_definition['__md5__'] = '01b680867c248074e939189100940687';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '01b680867c248074e939189100940687') {
				...
				self['__is_instance__'] && typeof self['__setattr__'] == 'function' ? self['__setattr__']('elem', self['createElement']()) : $p['setattr'](self, 'elem', self['createElement']()); 
				return null;
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('hookEvents', function() {
				...
				$m['DOM']['sinkEvents']($p['getattr'](self, 'elem'), $p['op_bitor']([$p['getattr']($m['Event'], 'MOUSEEVENTS'), $p['getattr']($m['Event'], 'KEYEVENTS'), $p['getattr']($m['Event'], 'ONCHANGE'), $p['getattr']($m['Event'], 'ONCLICK'), $p['getattr']($m['Event'], 'FOCUSEVENTS')]));
				return null;
			}
	, 1, [null,null,['self']]);
