...
$pyjs['loaded_modules']['logging'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['record']]);
		...
		$m['Handler'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = '0a723c8cd3c27b5746f029823a439fda';
			$method = $pyjs__bind_method2('__init__', function(level) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0a723c8cd3c27b5746f029823a439fda') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['record']]);
		...
		$m['DefaultStream'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = '5063bb6f5b0ce9de5984097641400415';
			$method = $pyjs__bind_method2('write', function(msg) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '5063bb6f5b0ce9de5984097641400415') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['msg']]);
		...
		$m['StreamHandler'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = '0f6a97b17a7de2b4ed0df15015514797';
			$method = $pyjs__bind_method2('__init__', function(strm) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '0f6a97b17a7de2b4ed0df15015514797') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['record']]);
		...
		$m['PlaceHolder'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = 'e5f292ad5e4d4a1f8c43030cac60b605';
			$method = $pyjs__bind_method2('__init__', function(alogger) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'e5f292ad5e4d4a1f8c43030cac60b605') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['alogger']]);
		...
		$m['Manager'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = '1ce464220c55bc4c441279192088fd41';
			$method = $pyjs__bind_method2('__init__', function(rootnode) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '1ce464220c55bc4c441279192088fd41') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['ph'],['alogger']]);
		...
		$m['Logger'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = 'b7ef447a549051a0323753e02085a15d';
			$method = $pyjs__bind_method2('__init__', function(name, level) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'b7ef447a549051a0323753e02085a15d') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self'],['level']]);
		...
		$m['RootLogger'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'logging';
			$cls_definition['__md5__'] = 'fe39747dbd1570a119cf5dd3b176b80c';
			$method = $pyjs__bind_method2('__init__', function(level) {
				if (this['__is_instance__'] === true) {
					var self = this;
					if ($pyjs['options']['arg_count'] && arguments['length'] != 1) $pyjs__exception_func_param(arguments['callee']['__name__'], 2, 2, arguments['length']+1);
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'fe39747dbd1570a119cf5dd3b176b80c') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
				...
				kwargs = $p['__empty_dict']();
{
		...
		$m['critical'] = function(msg) {
			...
			$pyjs_kwargs_call($m['root'], 'critical', null, kwargs, [{}, (typeof ($add19=$p['tuple']([msg]))==typeof ($add20=args) && (typeof $add19=='number'||typeof $add19=='string')?
				$add19+$add20:
		...
		$m['error'] = function(msg) {
			...
			$pyjs_kwargs_call($m['root'], 'error', null, kwargs, [{}, (typeof ($add21=$p['tuple']([msg]))==typeof ($add22=args) && (typeof $add21=='number'||typeof $add21=='string')?
				$add21+$add22:
		...
		$m['warning'] = function(msg) {
			...
			$pyjs_kwargs_call($m['root'], 'warning', null, kwargs, [{}, (typeof ($add25=$p['tuple']([msg]))==typeof ($add26=args) && (typeof $add25=='number'||typeof $add25=='string')?
				$add25+$add26:
		...
		$m['info'] = function(msg) {
			...
			$pyjs_kwargs_call($m['root'], 'info', null, kwargs, [{}, (typeof ($add27=$p['tuple']([msg]))==typeof ($add28=args) && (typeof $add27=='number'||typeof $add27=='string')?
				$add27+$add28:
		...
		$m['debug'] = function(msg) {
			...
			$pyjs_kwargs_call($m['root'], 'debug', null, kwargs, [{}, (typeof ($add29=$p['tuple']([msg]))==typeof ($add30=args) && (typeof $add29=='number'||typeof $add29=='string')?
				$add29+$add30:
		...
		$m['log'] = function(level, msg) {
			...
			$pyjs_kwargs_call($m['root'], 'log', null, kwargs, [{}, (typeof ($add31=$p['tuple']([level, msg]))==typeof ($add32=args) && (typeof $add31=='number'||typeof $add31=='string')?
				$add31+$add32:
