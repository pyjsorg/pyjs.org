/* start module: libtimesheet.view.DialogMediator */
$pyjs['loaded_modules']['libtimesheet.view.DialogMediator'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libtimesheet.view.DialogMediator']['__was_initialized__']) return $pyjs['loaded_modules']['libtimesheet.view.DialogMediator'];
	...
	var $m = $pyjs['loaded_modules']['libtimesheet.view.DialogMediator'];
	$m['__repr__'] = function() { return '<module: libtimesheet.view.DialogMediator>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libtimesheet.view.DialogMediator';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libtimesheet.view']['DialogMediator'] = $pyjs['loaded_modules']['libtimesheet.view.DialogMediator'];
	try {
		...
		$m['DialogMediator'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libtimesheet.view.DialogMediator';
			$cls_definition['__md5__'] = 'e620a4046e14f612f7f868d56af1de61';
			...
			$method = $pyjs__bind_method2('__init__', function(viewComponent) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'e620a4046e14f612f7f868d56af1de61') {
	...
	return this;
}; /* end libtimesheet.view.DialogMediator */


/* end module: libtimesheet.view.DialogMediator */
