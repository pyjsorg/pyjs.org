/* start module: libemployeeadmin.vo */
$pyjs['loaded_modules']['libemployeeadmin.vo'] = function (__mod_name__) {
	if($pyjs['loaded_modules']['libemployeeadmin.vo']['__was_initialized__']) return $pyjs['loaded_modules']['libemployeeadmin.vo'];
	...
	var $m = $pyjs['loaded_modules']['libemployeeadmin.vo'];
	$m['__repr__'] = function() { return '<module: libemployeeadmin.vo>'; };
	$m['__was_initialized__'] = true;
	if ((__mod_name__ === null) || (typeof __mod_name__ == 'undefined')) __mod_name__ = 'libemployeeadmin.vo';
	$m['__name__'] = __mod_name__;
	$pyjs['loaded_modules']['libemployeeadmin']['vo'] = $pyjs['loaded_modules']['libemployeeadmin.vo'];
	try {
		...
		$m['RoleVO'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.vo';
			$cls_definition['__md5__'] = '6d589ada42ee88795d9176cf5239ffcf';
			...
			$method = $pyjs__bind_method2('__init__', function(username, roles) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '6d589ada42ee88795d9176cf5239ffcf') {
	...
	, 1, [null,null,['self'],['username', null],['roles', null]]);
		...
		$m['UserVO'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'libemployeeadmin.vo';
			$cls_definition['__md5__'] = 'f404ee4865ea6f974d0a0f7b45b9846e';
			$cls_definition['username'] = null;
			...
			$method = $pyjs__bind_method2('__init__', function(uname, fname, lname, email, password, department) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'f404ee4865ea6f974d0a0f7b45b9846e') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	return this;
}; /* end libemployeeadmin.vo */


/* end module: libemployeeadmin.vo */
