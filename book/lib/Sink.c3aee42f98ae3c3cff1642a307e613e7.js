...
$pyjs['loaded_modules']['Sink'] = function (__mod_name__) {
	...
	try {
		...
		$m['Sink'] = (function(){
			...
			$cls_definition['__md5__'] = '163510f857046b3f0ec09cb8b3c667d8';
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '163510f857046b3f0ec09cb8b3c667d8') {
	...
	, 1, [null,null,['self']]);
		...
		$m['SinkInfo'] = (function(){
			...
			var $method;
			$cls_definition['__module__'] = 'Sink';
			$cls_definition['__md5__'] = '9d80626ab11be25b25d2d5b5840ec32a';
			$method = $pyjs__bind_method2('__init__', function(name, desc, object_type) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '9d80626ab11be25b25d2d5b5840ec32a') {
						if (!$p['_isinstance'](self, arguments['callee']['__class__'])) {
							$pyjs__exception_func_instance_expected(arguments['callee']['__name__'], arguments['callee']['__class__']['__name__'], self);
						}
					}
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getInstance', function() {
				...
				if ($p['bool']($p['op_eq']($p['getattr'](self, 'instance'), null))) {
